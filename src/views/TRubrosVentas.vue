<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSourceRubrosVentas" :transport-read="readData" :transport-update="updateData"
      ...
      <grid ref="grid" :height="'100vh'" :data-source-ref="'remoteDataSourceRubrosVentas'" :navigatable="true"
        :filterable="true" :pageable='false' :sorteable="true" :sortable-mode="'multiple'" :sortable-allow-unsort="true"
