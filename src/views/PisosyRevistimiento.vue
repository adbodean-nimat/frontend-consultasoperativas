<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSourcePyR" :transport-read="readData" :schema-model-fields="schemaModelFields"
        :page-size='200' :serverSorting="false">
      </datasource>
      <grid ref="grid" :height="'95vh'" :data-source-ref="'remoteDataSourcePyR'" :sortable="false" :filterable="true"
        :reorderable="true" :resizable="true" :groupable="false" :column-menu="true" :toolbar="toolbarTemplate"
        :excel-file-name="'LP VN - Pisos y Revistimiento.xlsx'" :excel-all-pages="true" :excel-filterable="false"
        :allow-copy="true" :selectable="true" :navigatable="true" :auto-bind="false" @excelexport="excelExport">
