<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSource2" :transport-read="readData" :schema-model-fields="schemaModelFields"
        :page-size='20'>
      </datasource>
      <grid ref="grid" :height="'95vh'" :data-source-ref="'remoteDataSource2'" :sortable-mode="'multiple'"
        ...
        <grid-column field="Fecha_alta_cliente" title="Fecha alta cliente" type="date" format="{0:dd-MM-yyyy}"
