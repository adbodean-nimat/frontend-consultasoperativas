<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSourceRubrosVtas" :transport-read="readData" :schema-model-fields="schemaModelFields"
        :group="groupDefinicion">
      </datasource>
      <grid ref="grid" :height="'95vh'" :data="'remoteDataSourceRubrosVtas'"
        :data-source-ref="'remoteDataSourceRubrosVtas'" :sortable-mode="'multiple'" :groupable-enabled="false"
        ...
        :excel-file-name="'LP VN - Rubros Vtas.xlsx'" :excel-all-pages="true" :excel-filterable="false"
        :pdf-file-name="'LP VN - Rubros Vtas.pdf'" :pdf-all-pages="true" :pdf-avoid-links="false" :pdf-paper-size="'A4'"
        :pdf-margin-top="200" :pdf-margin-bottom="10" :pdf-margin-left="10" :pdf-margin-right="10"
        :pdf-landscape="false" :pdf-repeat-headers="true" :pdf-scale="0.6" :pdf-template="pdfTemplate"
        @excelexport="excelExport" @pdfexport="pdfExport" @databound="dataBound">
        ...
        <grid-column field="VeriModif" title="Verfi Modif" :template="VeriModif" :hidden="true"></grid-column>
        <grid-column field="SinModif" title="Sin Modif" :template="SinModif" :hidden="true"></grid-column>
        <grid-column field="VeriSinModif" title="Verfi sin Modif" :template="VeriSinModif" :hidden="true"></grid-column>
  ...
  data: function () {
    return {
      ...
      schemaModelFields: {
        ...
        cod_set_art: { type: 'number' },
        nombre_set_art: { type: 'string' },
        cod_fami_art: { type: 'number' },
