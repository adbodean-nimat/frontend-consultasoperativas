<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSourceVblesEntrNPGral" :transport-read="readData"
        :schema-model-fields="schemaModelFields" :transport-parameter-map="parameterMap" :page-size='1000'>
      </datasource>
      <grid ref="grid" :height="'95vh'" :data-source-ref="'remoteDataSourceVblesEntrNPGral'" :sortable-mode="'multiple'"
        :pageable-page-sizes="[5, 10, 15, 20, 25, 100]" :sortable-allow-unsort="true" :sortable-show-indexes="true"
        :pageable-always-visible="true" :filterable="true" :filterable-extra="true" :reorderable="true"
        :resizable="true" :groupable="false" :column-menu="true" :auto-bind="false" :toolbar="toolbarTemplate"
        :allow-copy="true" :navigatable="true" :selectable="false" :scrollable-virtual="false"
        :scrollable-endless="false" :excel-file-name="'Variables Entregas NP - General.xlsx'" :excel-all-pages="true"
        ...
        <grid-column field="Fecha_Entr_Cabec" :title="'Fecha Entr. Cabec.'"
          template="#: kendo.toString(kendo.parseDate(Fecha_Entr_Cabec, 'yyyy-MM-dd'), 'dd/MM/yyyy') #"
          :width="120"></grid-column>
        <grid-column field="Fecha_Entr_Item" :title="'Fecha Entr. Item'"
          template="#: kendo.toString(kendo.parseDate(Fecha_Entr_Item, 'yyyy-MM-dd'), 'dd/MM/yyyy') #"
          :width="120"></grid-column>
        <grid-column field="Verif_fecha_entr" title="Verif. Fecha Entr." :width="200" :hidden="true"></grid-column>
...
export default {
  ...
  data: function () {
    return {
      ...
      teleport: true,
      pageOnly: true,
      dataSource: ['remoteDataSourceVblesEntrNPGral'],
