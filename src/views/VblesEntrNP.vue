<template>
    <div class="directive-fullscreen-wrapper">
      <div class="container-fluid page-grid">
        ...
        <datasource ref="remoteDataSourceVblesEntrNPGral"
        ...
        <grid ref="grid"
              :height="'95vh'"
              :data-source-ref="'remoteDataSourceVblesEntrNPGral'"
              ...
              <grid-column field="Fecha_Entr_Cabec" :title="'Fecha Entr. Cabec.'" template="#: kendo.toString(kendo.parseDate(Fecha_Entr_Cabec, 'yyyy-MM-dd'), 'dd/MM/yyyy') #" :width="120"></grid-column>
              <grid-column field="Fecha_Entr_Item" :title="'Fecha Entr. Item'" template="#: kendo.toString(kendo.parseDate(Fecha_Entr_Item, 'yyyy-MM-dd'), 'dd/MM/yyyy') #" :width="120"></grid-column>
