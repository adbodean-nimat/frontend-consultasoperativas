<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSourceRemitosVtas" :transport-read="readData" :transport-update="updateData"
      ...
      <grid ref="grid" :height="'100vh'" :data-source-ref="'remoteDataSourceRemitosVtas'" :navigatable="true"
