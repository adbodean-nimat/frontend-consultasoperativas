<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSource3" :transport-read="readData" :transport-update="updateData"
        :transport-destroy="destroyData" :transport-create="createData" :transport-parameter-map="parameterMap"
        :schema-model-id="'id'" :schema-model-fields="fields" :page-size='15' :batch="true" @error="onError"
      ...
      <grid ref="grid" :height="'100vh'" :data-source-ref="'remoteDataSource3'" :navigatable="true" :filterable="true"
        ...
        <grid-column :field="'codigo_deposito'" :title="'Código Deposito'"></grid-column>
...
export default {
  ...
  computed: {
    UrlApiBase() {
      return `${process.env.VUE_APP_API_BASE}/depositoanoconsiderarparastockfisico/`
    },
    token() {
  ...
  methods: {
    ...
    updateData: function (e) {
      ...
      kendo.jQuery.ajax({
        ...
        data: JSON.stringify(e.data.models[0], ["codigo_deposito", "nombre_deposito"]),
        dataType: 'json',
