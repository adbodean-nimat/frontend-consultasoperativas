    ...
    <div class="container-fluid page-grid">
      ...
      <grid ref="grid" :height="'95vh'" :data="'remoteDataSourceDistribucion'"
        ...
        <grid-column field="DCA1_POR_DESCUENTO" title="Dto. Cliente"
          template="#=kendo.format('{0:p0}', DCA1_POR_DESCUENTO / 100)#" :width="80" :hidden="false"></grid-column>
        ...
        <grid-column field="nombre_fami_art" title="Familia Art." :hidden="true"
          :group-header-template="groupHeaderTemplateNombreArt"></grid-column>
        ...
        <grid-column title="Orden más nombre de la familia" :template="OrdenMasNombre" :width="100"
