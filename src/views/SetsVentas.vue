<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSourceSetsVtas" :transport-read="readData" :schema-model-fields="schemaModelFields"
        :group="groupDefinicion" @error="onError" @requestend="requestEnd">
      </datasource>
      <grid ref="grid" :height="'100vh'" :data="'remoteDataSourceSetsVtas'"
        :data-source-ref="'remoteDataSourceSetsVtas'" :sortable-mode="'multiple'" :groupable-enabled="false"
        :filterable="true" :filterable-extra="false" :reorderable="true" :pageable="true" :resizable="true"
        :column-menu="true" :navigatable="false" :toolbar="toolbarTemplate" :allow-copy="true" :selectable="true"
        :auto-bind="false" :excel-file-name="'LP VN - Sets Vtas.xlsx'" :excel-all-pages="true" :excel-filterable="false"
        :pdf-file-name="'LP VN - Sets Vtas.pdf'" :pdf-all-pages="true" :pdf-avoid-links="false" :pdf-paper-size="'A4'"
