    ...
    <div class="container-fluid page-grid">
      <div class="encabezado-titulo">
        <div style="margin-left: 5px; color: white;" class="icon-title">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#fff" class="bi bi-person-lines-fill"
            viewBox="0 0 16 16">
            <path
      ...
      <datasource ref="remoteDataSource" :transport-read="readData" :schema-model-fields="schemaModelFields"
        :page-size='20'>
      </datasource>
      <grid ref="grid" :height="'95vh'" :data-source-ref="'remoteDataSource'" :sortable-mode="'multiple'"
        :sortable-allow-unsort="true" :sortable-show-indexes="true" :pageable-always-visible="true"
        :pageable-page-sizes="[5, 10, 15, 20, 25, 100]" :filterable="true" :filterable-extra="false" :reorderable="true"
        :resizable="true" :groupable="true" :column-menu="true" :auto-bind="false" :toolbar="toolbarTemplate"
        :allow-copy="true" :navigatable="true" :selectable="true" :scrollable-virtual="false"
        :scrollable-endless="false">
        <grid-column field="CLIE_FECHA_ALTA" title="Fecha Alta" type="date" format="{0:dd-MM-yyyy}" :width="150"
          :locked="true"></grid-column>
        <grid-column field="AUDI_USUARIO" title="Auditoría" :filterable-search="true" :filterable-multi="true"
          :width="130" :locked="true"></grid-column>
        <grid-column field="USUA_NOMBRE" title="Nombre Usuario" :width="200" :filterable-multi="true"
          :locked="true"></grid-column>
        ...
        <grid-column field="CLPF_FECHA_NACIM" title="Fecha nacimiento" type="date" format="{0:dd-MM-yyyy}"
          :width="135"></grid-column>
