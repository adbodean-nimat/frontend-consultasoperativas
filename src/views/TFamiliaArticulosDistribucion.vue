<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSourceFamiliaArticulosDistribucion" :transport-read="readData"
        ...
        @error="onError" @requestend="requestEnd" :page-size='100'>
      </datasource>
      <grid ref="grid" :height="'100vh'" :data-source-ref="'remoteDataSourceFamiliaArticulosDistribucion'"
        :navigatable="true" :filterable="true" :pageable='true' :pageable-always-visible="false"
        :pageable-page-sizes="[100, 200, 300, 400, 500]" :resizable="true" :sortable-mode="'multiple'"
        :sortable-allow-unsort="true" :sortable-show-indexes="true" :editable="'inline'" :toolbar="['create']">
        ...
        <grid-column :field="'nombre_familia_art'" :title="'Nombre Familia Art.'" :width="300" :filterable-multi="true"
          :filterable-search="true"></grid-column>
        <grid-column :field="'nro_orden_familia'" :title="'Nro. Orden de la familia'"></grid-column>
        <grid-column :field="'cod_set_art'" :title="'Código Set de la familia'"
          :editor="CodSetFamiliaDropDownEditor"></grid-column>
        <grid-column :field="'nombre_set_art'" :title="'Set de la familia'" :editor="SetFamiliaDropDownEditor"
          :filterable-multi="true"></grid-column>
