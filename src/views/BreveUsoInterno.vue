<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSourceBreveUsoInterno" :transport-read="readData"
        :schema-model-fields="schemaModelFields" :group="groupDefinition" :page-size='100'>
      </datasource>
      <grid ref="grid" :height="'95vh'" :data-source-ref="'remoteDataSourceBreveUsoInterno'" :sortable-mode="'multiple'"
        ...
        <grid-column field="grupo_del_art" title="Grupo del Art." :filterable-multi="true" :width="300"
        ...
        <grid-column field="comentario" title="Comentario"
          template=" #= Comentario1 ? Comentario1 : '' #  #= comentario ? comentario : '' #"></grid-column>
