<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSourceQR" :transport-read="readData" :schema-model-fields="schemaModelFields"
        :page-size='100'>
      </datasource>
      <grid ref="grid" :height="'95vh'" :data-source-ref="'remoteDataSourceQR'" :sortable="true"
        :pageable-page-sizes="[100, 200, 400]" :filterable="true" :reorderable="true" :resizable="true"
        :groupable="false" :column-menu="true" :navigatable="true" :auto-bind="false" :toolbar="toolbarTemplate"
        :allow-copy="true" :selectable="true" :scrollable="true">
        ...
        <grid-column field="NPCA_FECHA_EMI" title="Fecha de emisión" :filterable-ui="'datepicker'"
          :format="'{0:dd/MM/yyyy}'"></grid-column>
