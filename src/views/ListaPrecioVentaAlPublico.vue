<template>
    <div class="directive-fullscreen-wrapper">
      <div class="container-fluid page-grid">
        ...
        <datasource ref="remoteDataSourceListaPrecioVentaalPublico"
        ...
        <grid ref="grid"
              :height="'95vh'"
              :data-source-ref="'remoteDataSourceListaPrecioVentaalPublico'"
              :sortable-mode="'multiple'"
              :pageable-page-sizes="[5, 10, 15, 20, 25, 100, 250, 500]"
              :filterable="true"
              :reorderable="true"
              :resizable="true"
              :groupable="false"
            ...
            <grid-column field="Precio_base_pesos_contado_SI" title="Precio base contado SI" :format="'{0:c}'" :width="100"></grid-column>
