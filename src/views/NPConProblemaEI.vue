<template>
    <div class="directive-fullscreen-wrapper">
      <div class="container-fluid page-grid">
        ...
        <datasource ref="remoteDataSourceNPCPEI"
        ...
        <grid ref="grid"
              :height="'95vh'"
              :data-source-ref="'remoteDataSourceNPCPEI'"
              ...
              <grid-column :field="'NPCA_FECHA_EMI'" :title="'Fecha emisión'" :width="150" template="#: kendo.toString(kendo.parseDate(NPCA_FECHA_EMI, 'yyyy-MM-dd'), 'dd/MM/yyyy') #"></grid-column>
