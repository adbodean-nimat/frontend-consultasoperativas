        ...
        <div class="container-fluid page-grid min-vh-100 d-flex flex-column">
            <div class="encabezado-titulo">
                <div style="margin-left: 5px; color: white;" class="icon-title">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#fff" class="bi bi-boxes"
                        viewBox="0 0 16 16">
                        <path
            ...
            <div class="card my-0 directive-fullscreen-wrapper-grid h-screen"
...
<script>
import ControlStock from '../components/ControlStockNPOC.vue';
export default {
