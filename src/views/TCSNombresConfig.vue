<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataConstSecoNombresConfig" :transport-read="readData" :transport-update="updateData"
        :transport-destroy="destroyData" :transport-create="createData" :transport-parameter-map="parameterMap"
        :schema-model-id="'id'" :schema-model-fields="fields" :batch="true" :server-sorting="true"
        :sort-field="'cod_conf_cs'" :sort-dir="'desc'" @error="onError" @requestend="requestEnd">
      </datasource>
      <grid ref="grid" :height="'100vh'" :data-source-ref="'remoteDataConstSecoNombresConfig'" :navigatable="true"
          ...
          type: 'string', validation: {
            ...
            validarNumeric: function (input) {
              if (input.is("[name='cod_conf_cs']") && input.val() != "") {
                input.attr("data-validarNumeric-msg", "Debe tener hasta 3 caracteres.");
  ...
  methods: {
    ...
    updateData: function (e) {
      ...
      kendo.jQuery.ajax({
        ...
        data: JSON.stringify(e.data.models[0], ["cod_conf_cs", "nombre_conf_cs"]),
        dataType: 'json',
