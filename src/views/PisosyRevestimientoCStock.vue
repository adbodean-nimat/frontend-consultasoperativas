<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSourcePyRconStock" :transport-read="readData" :schema-model-fields="schemaModelFields"
        :page-size='200' :serverSorting="false">
      </datasource>
      <grid ref="grid" :height="'95vh'" :data-source-ref="'remoteDataSourcePyRconStock'" :sortable="false"
        :filterable="true" :reorderable="true" :resizable="true" :groupable="false" :column-menu="true"
        :toolbar="toolbarTemplate" :excel-file-name="'LP VN - Pisos y Revestimiento con stock.xlsx'"
        :excel-all-pages="true" :excel-filterable="false" :allow-copy="true" :selectable="true" :navigatable="true"
        :auto-bind="false" @excelexport="excelExport">
        ...
        <grid-column field="ARTS_ARTICULO_EMP" title="Código"
          template="#: kendo.toString(ARTS_ARTICULO_EMP, '00000000') #" :width="100" :hidden="false"></grid-column>
        <grid-column field="ARTS_NOMBRE" title="Nombre" :width="400" :hidden="false"></grid-column>
        <grid-column field="Pre_Cdo_con_IVA_L1" title="Precio de la Caja"
          template="#: kendo.toString(Pre_Cdo_con_IVA_L1, 'c2')#" :hidden="false"></grid-column>
        <grid-column field="PrecioContadoIVAcDtosM2" title="Precio del M2 aprox." :template="PrecioContadoIVAcDtosM2"
          :autoWidth="true" :hidden="false"></grid-column>
        <grid-column field="RAC_M2" title="RAC M2" :autoWidth="true" :hidden="false"></grid-column>
        <grid-column field="Stock_Uni" title="Stock Uni" :hidden="false"></grid-column>
        <grid-column field="Stock_M2" title="Stock en M2" :hidden="false"></grid-column>
        <grid-column field="M2_Pte_Entr_NP" title="M2 Pte Entr NP" :hidden="false"></grid-column>
        <grid-column field="M2_Disp_Habil_Vta" title="M2 Disp Habil Vta" :autoWidth="true"
          :hidden="false"></grid-column>
        <grid-column field="Bloqueado_Vtas" title="Bloqueado Vtas" :hidden="false"></grid-column>
        <grid-column field="M2_Bloqueado_Vta" title="M2 Bloqueado Vta" :hidden="false"></grid-column>
        ...
        <grid-column field="StockCaja" title="Stock Caja" :template="StockCaja" :type="'numeric'" :autoWidth="true"
...
export default {
  ...
  data: function () {
    return {
      ...
      teleport: true,
      pageOnly: true,
      title: 'Lista de precios - Pisos y Revestimiento con Stock',
      schemaModelFields: {
        CA03_NOMBRE: { type: 'string' },
        Tipología: { type: 'string' },
        ARTS_ARTICULO_EMP: { type: 'number' },
