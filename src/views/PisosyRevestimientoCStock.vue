<template>
    <div class="directive-fullscreen-wrapper">
      <div class="container-fluid page-grid">
        ...
        <datasource ref="remoteDataSourcePyRconStock"
        ...
        <grid ref="grid"
              :height="'95vh'"
              :data-source-ref="'remoteDataSourcePyRconStock'"
              :sortable="false"
              :filterable="true"
              :reorderable="true"
              :resizable="true"
              ...
              :excel-file-name="'LP VN - Pisos y Revestimiento con stock.xlsx'"
              ...
              <grid-column field="M2_Disp_Habil_Vta" title="M2 Disp Habil Vta" :autoWidth="true" :hidden="false"></grid-column>
              ...
              <grid-column field="StockCaja" title="Stock Caja" :template="StockCaja" :type="'numeric'" :autoWidth="true" :hidden="true"></grid-column>
