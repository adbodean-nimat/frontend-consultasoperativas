<template>
    <div class="directive-fullscreen-wrapper">
      ...
      <datasource ref="remoteDataSourceCartelManual"
      ...
      <grid ref="grid"
                  :height="'100vh'"
                  :data-source-ref="'remoteDataSourceCartelManual'"
                  :navigatable="true"
                  :filterable="true"
                  :pageable='true'
            ...
            <grid-column :command="['edit','destroy', {text:'Imprimir', click: customPrint}]" :title="'&nbsp;'"></grid-column>
      </grid>
    </div>
    </div>
    </template>
