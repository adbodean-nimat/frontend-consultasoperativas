<template>
    <div class="directive-fullscreen-wrapper">
      ...
      <grid ref="grid"
            ...
            <grid-column :field="'url_tablas'" :title="'URL'"></grid-column>
      ...
      data () {
             return {
                ...
                fields: {
                    ...
                    nombre_tablas: { type: 'varchar'},
                    url_tablas: { type: 'varchar'},
                }
             }
        },
      computed: {
       ...
       methods: {
            ...
            parameterMap: function(options, operation) {            
                ...
                if (operation == 'create') {
                    let params = JSON.stringify(options.models[0],["nombre_tablas","url_tablas"])
