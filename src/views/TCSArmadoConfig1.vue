<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataConstSecoArmadoConfig1" :transport-read="readData" :transport-update="updateData"
      ...
      <grid ref="grid" :height="'100vh'" :data-source-ref="'remoteDataConstSecoArmadoConfig1'" :navigatable="true"
      ...
      fields: {
          ...
          type: 'string', validation: {
            ...
            minLengthCodPtf: function (input) {
              if (input.is("[name='codptf']") && input.val() != "") {
                input.attr("data-minLengthCodPtf-msg", "Debe tener hasta 8 caracteres");
          ...
          type: 'string', validation: {
            ...
            minLengthConfigCS: function (input) {
              if (input.is("[name='configcs']") && input.val() != "") {
                input.attr("data-minLengthConfigCS-msg", "Debe tener hasta 3 caracteres");
        ...
        cant: {
          type: 'numeric', validation: {
            required: true,
            minLengthCant: function (input) {
              if (input.is("[name='cant']") && input.val() != "") {
                input.attr("data-minLengthCant-msg", "Debe tener hasta 3 decimales");
                return /^(\d+\.{1}\d{3})$/.test(input.val());
              }
              return true;
            }
          }
