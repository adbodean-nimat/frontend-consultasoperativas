<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSourceComprobantes" :transport-read="readData" :transport-update="updateData"
      ...
      <grid ref="grid" :height="'95vh'" :data-source-ref="'remoteDataSourceComprobantes'" :navigatable="true"
