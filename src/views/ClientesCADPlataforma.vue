<template>
    <div class="directive-fullscreen-wrapper">
      <div class="container-fluid page-grid">
        ...
        <datasource ref="remoteDataSourceClientesCADPlataforma"
        ...
        <grid ref="grid"
              :height="'95vh'"
              :data-source-ref="'remoteDataSourceClientesCADPlataforma'"
              :sortable-mode="'multiple'"
              :sortable-allow-unsort="true"
              :sortable-show-indexes="true"
              :pageable-always-visible="true"
              :pageable-page-sizes="[5, 10, 15, 20, 25, 100, 200, 500]"
              :filterable="true"
              ...
              :excel-file-name="'Lista de Clientes entre CAD y Plataforma.xlsx'"
              ...
              <grid-column field="CLIE_CAD" title="Disponible en CAD" template="#= CLIE_CAD == true ? 'Si' : 'No' #"></grid-column>
    ...
    methods: {
        ...
        change: function(e){
            ...
            console.log(JSON.stringify(selectedDataItems));
        }
    },
    mounted: function(){               
        var grid = this.$refs.grid.kendoWidget();
