<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSourceInformesAcindarEntreFechas" :transport-read="readData"
        :schema-model-fields="schemaModelFields" :aggregate="aggregateDefinition" :page-size='100'>
      </datasource>
      <grid ref="grid" :height="'95vh'" :data-source-ref="'remoteDataSourceInformesAcindarEntreFechas'"
        :sortable-mode="'multiple'" :sortable-allow-unsort="true" :sortable-show-indexes="true"
        :pageable-page-sizes="[100, 200, 400]" :filterable="true" :reorderable="true" :resizable="true"
        :groupable="false" :column-menu="true" :navigatable="true" :auto-bind="false"
        :excel-file-name="'Exportar Acindar.xlsx'" :excel-all-pages="true" :excel-filterable="false"
        :toolbar="toolbarTemplate" :allow-copy="true" :selectable="true" @databound="dataBound">
