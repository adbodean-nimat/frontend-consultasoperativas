    ...
    <div class="directive-fullscreen-wrapper">
      <div class="container-fluid page-grid">
        ...
        <grid ref="grid"
              ...
              <grid-column field="Uni_Pte_Entr_NP" title="Uni_Pte_Entr_NP" :width="120" :aggregates="['sum']" :footer-template="'#=sum#'"></grid-column>
              <grid-column field="Stk_Disp_pVta" title="Stk Disp p/Vta" :width="120" :aggregates="['sum']" :footer-template="'#=sum#'"></grid-column>
              ...
              <grid-column field="Cant_Mov_Nro" title="Cant Mov Nro" :width="120"></grid-column>
              ...
              <grid-column field="Depósito" title="Depósito" :width="120"></grid-column>
              ...
              <grid-column field="Año_de_fabricación" title="Año de fabricación" :width="120"></grid-column>
              <grid-column field="Peso_aprox_Kg" title="Peso aprox Kg" :width="120"></grid-column>
              <grid-column field="Nro_cliente" title="Nro. cliente" :width="120"></grid-column>
              <grid-column field="Nombre_Cliente" title="Nombre Cliente" :width="300"></grid-column>
              <grid-column field="Observación_NP" title="Observación NP" :width="600"></grid-column>
              <grid-column field="Vendedor" title="Vendedor" :width="150"></grid-column>
              <grid-column field="Medidas_interiores" title="Medidas_interiores" :width="400"></grid-column>
