<template>
    <div class="directive-fullscreen-wrapper">
      <div class="container-fluid page-grid">
        ...
        <datasource ref="remoteDataSourceCartelCodArt"
        ...
        <grid ref="grid"
              :height="'95vh'"
              :data-source-ref="'remoteDataSourceCartelCodArt'"
              ...
              <grid-column field="Pre_M2_UN_Lista_con_IVA_L1" title="Precio Lista c/IVA" template="#: kendo.toString(Pre_M2_UN_Lista_con_IVA_L1, 'c2')#"></grid-column>
              <grid-column field="Pre_M2_UN_Cdo_con_IVA_L1"  title="Precio Cdo. c/IVA" template="#: kendo.toString(Pre_M2_UN_Cdo_con_IVA_L1, 'c2')#"></grid-column>
              <grid-column field="Pre_M2_UN_Cdo_con_IVA_L1_Redond" title="Precio Cdo. c/IVA Redondeo" template="#: kendo.toString(Pre_M2_UN_Cdo_con_IVA_L1_Redond, 'c0')#"></grid-column>
        </grid>
      </div>
    </div>
    </template>
