<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSourceCartelCodArt" :transport-read="readData" :schema-model-fields="schemaModelFields"
        :transport-parameter-map="parameterMap" :aggregate="aggregateDefinition" :page-size='1000'>
      </datasource>
      <grid ref="grid" :height="'95vh'" :data-source-ref="'remoteDataSourceCartelCodArt'" :sortable-mode="'multiple'"
        ...
        <grid-column field="Pre_M2_UN_Lista_con_IVA_L1" title="Precio Lista c/IVA"
          template="#: kendo.toString(Pre_M2_UN_Lista_con_IVA_L1, 'c2')#"></grid-column>
        <grid-column field="Pre_M2_UN_Cdo_con_IVA_L1" title="Precio Cdo. c/IVA"
          template="#: kendo.toString(Pre_M2_UN_Cdo_con_IVA_L1, 'c2')#"></grid-column>
        <grid-column field="Pre_M2_UN_Cdo_con_IVA_L1_Redond" title="Precio Cdo. c/IVA Redondeo"
...
export default {
  ...
  data: function () {
    return {
      ...
      teleport: true,
      pageOnly: true,
      dataSource: ['remoteDataSourceCartelCodArt'],
      title: 'Cartel: Por Código Art.',
      schemaModelFields: {
  ...
  mounted: function () {
    ...
    toolbarElement.on("click", ".print", function () {
      ...
      var contentBody =
        ...
        '<div class="row mb-4">' +
        '<div class="col"></div>' +
        '<div class="col text-center bg-success text-white"><span style="font-size: 25px;"><strong>Precio contado*</strong></span></div>' +
        '<div class="col"></div>' +
        '</div>' +
