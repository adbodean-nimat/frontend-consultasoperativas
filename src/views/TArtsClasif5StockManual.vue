<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSourceArtsClasif5StockManual" :transport-read="readData" :transport-update="updateData"
      ...
      <grid ref="grid" :height="'100vh'" :data-source-ref="'remoteDataSourceArtsClasif5StockManual'" :navigatable="true"
        :filterable="true" :pageable='false' :editable="'inline'" :toolbar="['create']">
        <grid-column :field="'id'" :title="'Id'" :hidden="true"></grid-column>
        <grid-column :field="'arts_clasif_5'" :title="'Cod. Arts. Clasif. 5'"></grid-column>
        <grid-column :field="'stock_manual'" :title="'Stock'"></grid-column>
...
export default {
  name: 'ArtsClasif5StockManualWeb',
  directives: {
    fullscreen,
  },
  components: {
  ...
  data() {
    return {
      ...
      teleport: true,
      pageOnly: true,
      title: 'Comprobantes a Omitir',
      fields: {
        id: { editable: false, type: 'number', nullable: true },
        arts_clasif_5: { type: 'string' },
        stock_manual: { type: 'string' },
      }
    }
  },
  computed: {
