<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSourceLPBUI" :transport-read="readData" :transport-update="updateData"
      ...
      <grid ref="grid" :height="'95vh'" :data-source-ref="'remoteDataSourceLPBUI'" :navigatable="true"
        :filterable="true" :pageable='true' :resizable="true" :reorderable="true" :sortable-mode="'multiple'"
        ...
        <grid-column :field="'nro_orden_art'" :title="'Nro. Orden Art'" :width="100"
