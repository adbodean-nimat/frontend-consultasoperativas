<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSourceClasifClientes" :transport-read="readData" :transport-update="updateData"
      ...
      <grid ref="grid" :height="'95vh'" :data-source-ref="'remoteDataSourceClasifClientes'" :navigatable="true"
        ...
        <grid-column :field="'clasif_1_ptf'" :title="'Clasif. 1 Plataforma'"></grid-column>
        <grid-column :field="'segmento_cliente_acindar'" :title="'Segmento Cliente Acindar'"></grid-column>
        <grid-column :field="'descrip_segmento'" :title="'Descripción segmento'"></grid-column>
...
export default {
  ...
  data() {
    return {
      ...
      fields: {
        ...
        clasif_1_ptf: { type: 'string' },
        segmento_cliente_acindar: { type: 'string' },
        descrip_segmento: { type: 'string' },
  ...
  computed: {
    UrlApiBase() {
      return `${process.env.VUE_APP_API_BASE}/acindarclasifclientes/`
    },
    token() {
