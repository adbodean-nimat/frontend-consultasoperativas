<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSourceArticulosWeb" :transport-read="readData" :transport-update="updateData"
      ...
      <datasource ref="remoteDataSourceArticulosWeb2" :transport-read="readData" :batch="true">
      </datasource>

      <datasource ref="remoteDataSourceCategoriasWeb" :transport-read="readDataCategorias" :batch="true">
      </datasource>

      <datasource ref="remoteDataSourceActualizacionWeb" :transport-read="readDataActualizacion" :batch="true">
      </datasource>

      <grid id="grid" ref="grid" :height="'95vh'" :data-source-ref="'remoteDataSourceArticulosWeb'" :navigatable="true"
        :filterable="true" :reorderable="true" :resizable="true" :column-menu="true" :pageable="true"
        :sortable-mode="'multiple'" :editable="'popup'"
        ...
        <grid-column :field="'publicado'" :title="'Publicado'" template="#= publicado == true ? 'Si' : 'No' #"
        ...
        <grid-column :field="'marcar_nuevo'" :title="'Marcar como nuevo'"
          template="#= marcar_nuevo == true ? 'Si' : 'No' #" :width="100"></grid-column>
        <grid-column :field="'mostrar_inicio'" :title="'Mostrar en la página de inicio'"
          template="#= mostrar_inicio == true ? 'Si' : 'No' #" :width="100"></grid-column>
        <grid-column :field="'outlet'" :title="'Outlet'" template="#= outlet == true ? 'Si' : 'No' #"
          :width="100"></grid-column>
        ...
        <grid-column :field="'bloq_vtas'" :title="'Ver si Bloq. Vtas?'" template="#= bloq_vtas == true ? 'Si' : 'No' #"
          :width="100"></grid-column>
        ...
        <grid-column :field="'categorias1'" :title="'Categoria 1'" :editor="GetCategoriasWeb" :width="50"
          :hidden="true"></grid-column>
        <grid-column :field="'namecategorias1'" :title="'Categoria 1'" :template="templateNameCategorias1"
          :width="200"></grid-column>
        <grid-column :field="'categorias2'" :title="'Categoria 2'" :editor="GetCategoriasWebResto" :width="100"
          :hidden="true"></grid-column>
        <grid-column :field="'namecategorias2'" :title="'Categoria 2'" :template="templateNameCategorias2"
          :width="200"></grid-column>
        <grid-column :field="'categorias3'" :title="'Categoria 3'" :editor="GetCategoriasWebResto" :width="100"
          :hidden="true"></grid-column>
        <grid-column :field="'namecategorias3'" :title="'Categoria 3'" :template="templateNameCategorias3"
          :width="200"></grid-column>
        <grid-column :field="'categorias4'" :title="'Categoria 4'" :editor="GetCategoriasWebResto" :width="100"
          :hidden="true"></grid-column>
        <grid-column :field="'namecategorias4'" :title="'Categoria 4'" :template="templateNameCategorias4"
          :width="200"></grid-column>
      </grid>
    </div>
  </div>
