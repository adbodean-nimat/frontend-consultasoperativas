<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <grid ref="grid" :height="'95vh'" :data-source-ref="'remoteDataSourcePyR'" :filterable="true" :pageable='true'
        :pageable-always-visible="false" :pageable-page-sizes="[200, 300, 400, 500]" :sortable-mode="'multiple'"
        :sortable-allow-unsort="true" :sortable-show-indexes="true" :reorderable="true" :resizable="true"
        :groupable="false" :column-menu="true" :toolbar="toolbarTemplate"
        :excel-file-name="'LP VN - Pisos y Revestimiento.xlsx'" :excel-all-pages="true" :excel-filterable="false"
        ...
        <grid-column field="PrecioContadoIVAcDtosM2" title="Precio del M2 aprox."
          template="#: kendo.toString(PrecioContadoIVAcDtosM2, 'c2')#" :autoWidth="true" :hidden="false"></grid-column>
