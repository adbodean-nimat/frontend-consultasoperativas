<template>
  <div class="directive-fullscreen-wrapper">
    <div class="container-fluid page-grid">
      ...
      <datasource ref="remoteDataSourceCartelM2" :transport-read="readData" :schema-model-fields="schemaModelFields"
        :transport-parameter-map="parameterMap" :aggregate="aggregateDefinition" :page-size='1000'>
      </datasource>
      <grid ref="grid" :height="'95vh'" :data-source-ref="'remoteDataSourceCartelM2'" :sortable-mode="'multiple'"
        ...
        <grid-column field="Pre_Lista_con_IVA_L1" title="Precio Lista c/IVA"
          template="#: kendo.toString(Pre_Lista_con_IVA_L1, 'c2')#"></grid-column>
...
export default {
  ...
  mounted: function () {
    ...
    toolbarElement.on("click", ".print", function () {
      ...
      var itemPrecioCdoSinRedond = data[0].Pre_M2_UN_Cdo_con_IVA_L1
      ...
      var contentBody =
        ...
        '<span><small>Precio del M2: </small></span><span style="font-size: 20px;"><strong>' + kendo.toString(itemPrecioCdoSinRedond, "c2") + '</strong></span>' +
        '</div>' +
