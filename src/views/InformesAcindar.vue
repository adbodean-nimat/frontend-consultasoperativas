<template>
    <div class="directive-fullscreen-wrapper">
      <div class="container-fluid page-grid">
        ...
        <datasource ref="remoteDataSourceInformesAcindar"
        ...
        <grid ref="grid"
              :height="'95vh'"
              :data-source-ref="'remoteDataSourceInformesAcindar'"
              :sortable="true"
        ...
        <grid-column field="MONTO" title="MONTO" :aggregates="['sum']" footer-template="#= kendo.toString(sum, 'c2') #" format="{0:c}"></grid-column>
