                    ...
                    <div class="col col-h">
                        <router-link to="/co">
                            <div class="d-flex flex-column justify-content-between rounded-top bg-white">
                                <div
                                    class="w-100 column d-flex flex-row justify-content-between p-3 text-secondary link-success">
                    ...
                    <div class="col col-h" v-if="hasRole(['Gerencia', 'Sistemas', 'Compras', 'Exhibicion'])">
                        <router-link to="/gdc">
                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title="Ingresar a la gestión de compras.">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-question-circle-fill text-secondary"
                                            viewBox="0 0 16 16">
                                            <path
                            ...
                            <div
                                class="column-bottom text-center h-10 d-flex justify-content-between align-items-center rounded-bottom px-4 bg-light">
                                <span class="fs-6 text-secondary">1.0.0</span>
                                <span class="fs-6 text-secondary">GDC</span>
                            </div>
                        </router-link>
                    </div>
                    <div class="col col-h" v-if="hasRole(['Gerencia', 'Sistemas', 'Ventas'])">
                        <router-link to="/gdd">
                            ...
                            <div
                                class="column-bottom text-center h-10 d-flex justify-content-between align-items-center rounded-bottom px-4 bg-light">
                                <span class="fs-6 text-secondary">1.0.0</span>
                                <span class="fs-6 text-secondary">GDD</span>
                            </div>
                        </router-link>
                    </div>
                    <div class="col col-h" v-if="hasRole(['Gerencia', 'Sistemas', 'Administracion y Finanzas'])">
                        <router-link to="/gdf">
                            ...
                            <div
                                class="column-bottom text-center h-10 d-flex justify-content-between align-items-center rounded-bottom px-4 bg-light">
                                <span class="fs-6 text-secondary">1.0.0</span>
                                <span class="fs-6 text-secondary">GDF</span>
                            </div>
                        </router-link>
                    </div>
                    <div class="col col-h"
                    ...
                    <div class="col col-h" v-if="hasRole(['Gerencia', 'Sistemas', 'Administracion y Finanzas'])">
                        <router-link to="/gda">
                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title="Ingresar a la gestión de Administración.">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-question-circle-fill text-secondary"
                                            viewBox="0 0 16 16">
                                            <path
                            ...
                            <div
                                class="column-bottom text-center h-10 d-flex justify-content-between align-items-center rounded-bottom px-4 bg-light">
                                <span class="fs-6 text-secondary">1.0.0</span>
                                <span class="fs-6 text-secondary">GDA</span>
                            </div>
                        </router-link>
                    </div>
                    <div class="col col-h" v-if="hasRole(['Gerencia', 'Sistemas'])">
                        <router-link to="/gds">
                            <div class="d-flex flex-column justify-content-between rounded-top bg-white">
                                <div
                                    class="column d-flex flex-row justify-content-between p-3 text-secondary link-success">
                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title="Ingresar a la gestión de Sistemas.">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-question-circle-fill text-secondary"
                                            viewBox="0 0 16 16">
                                            <path
                            ...
                            <div
                                class="column-bottom text-center h-10 d-flex justify-content-between align-items-center rounded-bottom px-4 bg-light">
                                <span class="fs-6 text-secondary">1.0.0</span>
                                <span class="fs-6 text-secondary">GDS</span>
                            </div>
                        </router-link>
                    </div>
                </div>
