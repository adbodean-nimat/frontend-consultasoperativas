    ...
    <div class="container-page">
        <div class="page-content">
            <div class="container-fluid px-4 text-center">
                <h3 style="color:#fff;">Cartelería</h3>
                <div class="row row-cols-lg-5 gy-5">
                    <div class="col col-h">
                        ...
                        <div class="column-bottom text-center h-10 d-flex justify-content-between align-items-center rounded-bottom px-4 bg-light">
                            ...
                            <span class="fs-6 text-secondary">CCO</span>
                        </div>
                    </router-link>
                    </div>
                    <div  class="col col-h">
                    <router-link to="/cartelerias/m2">
                        ...
                        <div class="column-bottom text-center h-10 d-flex justify-content-between align-items-center px-4 rounded-bottom bg-light">
                            <span class="fs-6 text-secondary">1.0.0</span>
                            <span class="fs-6 text-secondary">CM2</span>
                        </div>
                    </router-link>
                    </div>
                    <div  class="col col-h">
                    <router-link to="/cartelerias/m2saldo">
                        ...
                        <div class="column-bottom text-center h-10 d-flex justify-content-between align-items-center px-4 rounded-bottom bg-light">
                            <span class="fs-6 text-secondary">1.0.0</span>
                            <span class="fs-6 text-secondary">CM2S</span>
                        </div>
                    </router-link>
                    </div>
                    <div class="col col-h">
                    <router-link to="/cartelerias/articulo">
                        ...
                        <div class="column-bottom text-center h-10 d-flex justify-content-between align-items-center px-4 rounded-bottom bg-light">
                            <span class="fs-6 text-secondary">1.0.0</span>
                            <span class="fs-6 text-secondary">CART</span>
                        </div>
                    </router-link>
                    </div>
                    <div class="col col-h">
                    <router-link to="/cartelerias/manual">
                        ...
                        <div class="column-bottom text-center h-10 d-flex justify-content-between align-items-center px-4 rounded-bottom bg-light">
                            <span class="fs-6 text-secondary">1.0.0</span>
                            <span class="fs-6 text-secondary">CMAN</span>
                        </div>
                    </router-link>
                    </div>
