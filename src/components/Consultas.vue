                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title="Consulta para el control del alta de nuevos clientes en un rango de fechas.">
                    ...
                    <div v-if="IsAllow === 'cfernandez' || IsAllow === 'abodean' || IsAllow === 'avillasalte'"
                        ...
                        <router-link to="/listadeclientes">
                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title='Consulta para la verificación de los datos de los clientes.'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-question-circle-fill text-secondary"
                                            viewBox="0 0 16 16">
                                            <path
                    ...
                    <div class="col col-h">
                        <router-link to="/vblesentrnp">
                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title='Consulta Variables Entregas NP General'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-question-circle-fill text-secondary"
                                            viewBox="0 0 16 16">
                                            <path
                    ...
                    <div class="col col-h">
                        <router-link to="/containers">
                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title='Consulta para verificar disponibilidad de containers.'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-question-circle-fill text-secondary"
                                            viewBox="0 0 16 16">
                                            <path
                    ...
                    <div class="col col-h">
                        <router-link to="/pisosyrevestimientoconstock">
                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title='Consulta lista de precios de Pisos y Revistimiento con Stock'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-question-circle-fill text-secondary"
                                            viewBox="0 0 16 16">
                                            <path
                    ...
                    <div class="col col-h">
                        <router-link to="/breveusointerno">
                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title='Consulta lista de precios breve uso interno'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-question-circle-fill text-secondary"
                                            viewBox="0 0 16 16">
                                            <path
                    ...
                    <div class="col col-h">
                        <router-link to="/listaconstseco">
                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title='Consulta precios y consumo de Construcción Seco.'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-question-circle-fill text-secondary"
                                            viewBox="0 0 16 16">
                                            <path
                    ...
                    <div class="col col-h">
                        <router-link to="/listarubrosvtas">
                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title='Consulta lista de precios rubros ventas.'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-question-circle-fill text-secondary"
                                            viewBox="0 0 16 16">
                                            <path
                    ...
                    <div class="col col-h">
                        <router-link to="/listarubrosvtasacopio">
                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title='Consulta lista de precios rubros ventas acopio.'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-question-circle-fill text-secondary"
                                            viewBox="0 0 16 16">
                                            <path
                    ...
                    <div class="col col-h">
                        <router-link to="/listasetsvtas">
                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title='Consulta lista de precios por sets ventas.'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-question-circle-fill text-secondary"
                                            viewBox="0 0 16 16">
                                            <path
                    ...
                    <div class="col col-h">
                        <router-link to="/listadodistribucion">
                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title='Consulta lista de precios para distribución.'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-question-circle-fill text-secondary"
                                            viewBox="0 0 16 16">
                                            <path
                    ...
                    <div class="col col-h">
                        <router-link to="/rowaplancanjexsiempre">
                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title='Consulta lista de precio Plan Canje de Rowa'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-question-circle-fill text-secondary"
                                            viewBox="0 0 16 16">
                                            <path
                    ...
                    <div class="col col-h">
                        <router-link to="/combo">
                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title='Consulta lista de precio combo'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-question-circle-fill text-secondary"
                                            viewBox="0 0 16 16">
                                            <path
                    ...
                    <div class="col col-h">
                        <router-link to="/acopiocemento">
                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title='Consulta Acopio Loma Negra'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-question-circle-fill text-secondary"
                                            viewBox="0 0 16 16">
                                            <path
                    ...
                    <div v-if="IsAllow === 'rmuriel' || IsAllow === 'abodean' || IsAllow === 'avillasalte' || IsAllow === 'ejescobar' || IsAllow === 'sbarrios' || IsAllow === 'jbermudez' || IsAllow === 'vromero' || IsAllow === 'cbrun' || IsAllow === 'sberrutti'"
                        ...
                        <router-link to="/npconproblemaentregainmediata">
                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title='Consulta NTP con problema'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-question-circle-fill text-secondary"
                                            viewBox="0 0 16 16">
                                            <path
                    ...
                    <div v-if="IsAllow === 'mniez' || IsAllow === 'gescobar' || IsAllow === 'rmuriel' || IsAllow === 'abodean' || IsAllow === 'avillasalte' || IsAllow === 'ejescobar' || IsAllow === 'mniez'"
                        ...
                        <router-link to="/consultaordenescompra">
                            ...
                            <div
                                ...
                                <span class="fs-6">
                                    <div id="tooltip" data-toggle="tooltip" data-placement="right"
                                        title='Consulta Ordenes Compra - Fecha Ult. Vta.'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="currentColor" class="bi bi-question-circle-fill text-secondary"
                                            viewBox="0 0 16 16">
                                            <path
                        ...
                        <router-link to="/consultatiempoentregasinmediata">
                            <div class="d-flex flex-column justify-content-between rounded-top bg-white">
                                <div
                                    ...
                                    <div class="title-column" style="text-align: right;">
                                        Consulta Tiempo <br></br> Entregas Inmediata<br>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                class="column-bottom text-center h-10 d-flex justify-content-between align-items-center px-4 rounded-bottom bg-light">
                                <span class="fs-6 text-secondary">1.0.0</span>
                                <span class="fs-6 text-secondary">CTEI</span>
                            </div>
                        </router-link>
                    </div>
                </div>
