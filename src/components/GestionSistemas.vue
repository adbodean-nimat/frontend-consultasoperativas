                        ...
                        <router-link :to="{ name: 'avisosdeudawhatsapp' }">
                            <div class="d-flex flex-row justify-content-between rounded-top bg-white"
                                ...
                                <div class="p-3 title-column text-end" style="width: 70%;">
                                    <p>Seguimiento de avisos de deuda vencida por WhatsApp</p>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <span class="fs-6 text-secondary">VDW</span>
                            </div>
                        </router-link>
                    </div>
