...
.k-button-solid-warning.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(204, 154, 0, 0.75);
}
...
.k-button-outline-base.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(46, 46, 46, 0.75);
}
...
.k-button-outline-primary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(243, 88, 0, 0.75);
}
...
.k-button-outline-warning.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(255, 192, 0, 0.75);
}
...
.k-calendar td.k-focus .k-link {
  box-shadow: inset 0 0 4px 0px rgba(243, 88, 0, 0.75);
}
...
.k-fab-solid-primary:active {
  border-color: #c04600;
  background-color: #c04600;
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(243, 88, 0, 0.4);
}
...
.k-fab-solid-secondary:active {
  border-color: #4d4d4d;
  background-color: #4d4d4d;
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(102, 102, 102, 0.4);
}
...
.k-fab-solid-tertiary:active {
  border-color: #6f7400;
  background-color: #6f7400;
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(160, 167, 0, 0.4);
}
...
.k-bottom-nav-solid.k-bottom-nav-tertiary .k-bottom-nav-item:focus {
  background-color: rgba(222, 224, 166, 0.2);
}
...
.k-chip-solid-base.k-focus {
  box-shadow: 0 0 0 2px rgba(46, 46, 46, 0.16);
  background-color: rgba(46, 46, 46, 0.08);
}
