...
.k-button-solid-tertiary.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(0, 138, 154, 0.75);
}
...
.k-button-solid-info.k-hover {
  border-color: #15717d;
  background-color: #1b92a1;
}
.k-button-solid-info:focus,
.k-button-solid-info.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(24, 130, 143, 0.75);
}
...
.k-button-solid-success.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(57, 124, 59, 0.75);
}
...
.k-button-solid-warning.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(204, 147, 37, 0.75);
}
...
.k-button-solid-error.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(204, 30, 44, 0.75);
}
...
.k-button-outline-base.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(50, 54, 76, 0.75);
}
...
.k-button-outline-primary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(255, 67, 80, 0.75);
}
...
.k-button-outline-tertiary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(0, 172, 193, 0.75);
}
...
.k-button-outline-info.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(30, 162, 179, 0.75);
}
...
.k-button-outline-success.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(71, 155, 74, 0.75);
}
...
.k-button-outline-warning.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(255, 184, 46, 0.75);
}
...
.k-button-outline-error.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(255, 38, 55, 0.75);
}
...
.k-rating-item.k-hover.k-state-selected,
.k-rating-item:hover.k-selected,
.k-rating-item.k-state-hover.k-selected,
.k-rating-item.k-hover.k-selected {
  box-shadow: none;
}
.k-rating-item:focus,
...
.k-rating-item.k-focus.k-state-selected,
.k-rating-item:focus.k-selected,
.k-rating-item.k-state-focused.k-selected,
.k-rating-item.k-focus.k-selected {
  box-shadow: none;
}
...
.k-timeline-track-item.k-focus .k-timeline-circle {
  box-shadow: 0 3px 4px 0 rgba(255, 67, 80, 0.4);
}
.k-breadcrumb:focus,
...
.k-filemanager-listview .k-item.k-selected .k-icon {
  border-color: false;
  color: #32364c;
  background-color: false;
}
...
.k-fab-solid-primary:active {
  border-color: #ff1021;
  background-color: #ff1021;
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(255, 67, 80, 0.4);
}
...
.k-fab-solid-tertiary:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(0, 172, 193, 0.4);
}
...
.k-fab-solid-info:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(30, 162, 179, 0.4);
}
...
.k-fab-solid-success:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(71, 155, 74, 0.4);
}
...
.k-fab-solid-warning:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(255, 184, 46, 0.4);
}
...
.k-fab-solid-error:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(255, 38, 55, 0.4);
}
...
.k-bottom-nav-solid.k-bottom-nav-primary .k-bottom-nav-item.k-active,
...
.k-bottom-nav-solid.k-bottom-nav-primary .k-bottom-nav-item:focus {
  background-color: rgba(255, 189, 194, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-secondary .k-bottom-nav-item.k-active,
...
.k-bottom-nav-solid.k-bottom-nav-tertiary .k-bottom-nav-item.k-active,
...
.k-bottom-nav-solid.k-bottom-nav-tertiary .k-bottom-nav-item:focus {
  background-color: rgba(166, 226, 233, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-info .k-bottom-nav-item.k-active,
...
.k-bottom-nav-solid.k-bottom-nav-info .k-bottom-nav-item:focus {
  background-color: rgba(176, 222, 228, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-success .k-bottom-nav-item.k-active,
...
.k-bottom-nav-solid.k-bottom-nav-success .k-bottom-nav-item:focus {
  background-color: rgba(191, 220, 192, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-warning .k-bottom-nav-item.k-active,
...
.k-bottom-nav-solid.k-bottom-nav-warning .k-bottom-nav-item:focus {
  background-color: rgba(89, 64, 16, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-error .k-bottom-nav-item.k-active,
...
.k-bottom-nav-solid.k-bottom-nav-error .k-bottom-nav-item:focus {
  background-color: rgba(255, 179, 185, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-dark .k-bottom-nav-item.k-active,
...
.k-bottom-nav-solid.k-bottom-nav-light .k-bottom-nav-item.k-active,
...
.k-bottom-nav-solid.k-bottom-nav-inverse .k-bottom-nav-item.k-active,
...
.k-bottom-nav-flat.k-bottom-nav-primary .k-bottom-nav-item.k-active,
...
.k-bottom-nav-flat.k-bottom-nav-secondary .k-bottom-nav-item.k-active,
...
.k-bottom-nav-flat.k-bottom-nav-tertiary .k-bottom-nav-item.k-active,
...
.k-bottom-nav-flat.k-bottom-nav-info .k-bottom-nav-item.k-active,
...
.k-bottom-nav-flat.k-bottom-nav-success .k-bottom-nav-item.k-active,
...
.k-bottom-nav-flat.k-bottom-nav-warning .k-bottom-nav-item.k-active,
...
.k-bottom-nav-flat.k-bottom-nav-error .k-bottom-nav-item.k-active,
...
.k-bottom-nav-flat.k-bottom-nav-dark .k-bottom-nav-item.k-active,
...
.k-bottom-nav-flat.k-bottom-nav-light .k-bottom-nav-item.k-active,
...
.k-bottom-nav-flat.k-bottom-nav-inverse .k-bottom-nav-item.k-active,
...
.k-bottom-nav-flat .k-bottom-nav-item.k-focus.k-state-selected,
.k-bottom-nav-flat .k-bottom-nav-item.k-state-focus.k-selected,
.k-bottom-nav-flat .k-bottom-nav-item.k-focus.k-selected,
.k-bottom-nav-flat .k-bottom-nav-item.k-state-focused.k-state-selected,
.k-bottom-nav-flat .k-bottom-nav-item.k-focus.k-state-selected,
.k-bottom-nav-flat .k-bottom-nav-item.k-state-focused.k-selected,
.k-bottom-nav-flat .k-bottom-nav-item.k-focus.k-selected,
.k-bottom-nav-flat .k-bottom-nav-item.k-state-selected:focus,
.k-bottom-nav-flat .k-bottom-nav-item.k-selected:focus {
  background-color: rgba(50, 54, 76, 0.05);
}
...
.k-pivotgrid-row.k-selected > .k-pivotgrid-cell {
  background-color: rgba(255, 67, 80, 0.25);
}
...
.k-chip-solid-base {
  border-color: rgba(157, 162, 164, 0.3);
  color: #9da2a4;
  background-color: rgba(157, 162, 164, 0.08);
}
.k-chip-solid-base:hover,
.k-chip-solid-base.k-hover {
  background-color: rgba(157, 162, 164, 0.16);
}
.k-chip-solid-base:focus,
.k-chip-solid-base.k-focus {
  box-shadow: 0 0 0 2px rgba(157, 162, 164, 0.16);
  background-color: rgba(157, 162, 164, 0.08);
}
.k-chip-solid-base.k-selected {
  background-color: rgba(157, 162, 164, 0.24);
}
.k-chip-solid-success {
  border-color: rgba(71, 155, 74, 0.3);
  color: #479b4a;
  background-color: rgba(71, 155, 74, 0.08);
}
.k-chip-solid-success:hover,
.k-chip-solid-success.k-hover {
  background-color: rgba(71, 155, 74, 0.16);
}
.k-chip-solid-success:focus,
.k-chip-solid-success.k-focus {
  box-shadow: 0 0 0 2px rgba(71, 155, 74, 0.16);
}
.k-chip-solid-success.k-selected {
  background-color: rgba(71, 155, 74, 0.24);
}
.k-chip-solid-warning {
  border-color: rgba(255, 184, 46, 0.3);
  color: #ffb82e;
  background-color: rgba(255, 184, 46, 0.08);
}
.k-chip-solid-warning:hover,
.k-chip-solid-warning.k-hover {
  background-color: rgba(255, 184, 46, 0.16);
}
.k-chip-solid-warning:focus,
.k-chip-solid-warning.k-focus {
  box-shadow: 0 0 0 2px rgba(255, 184, 46, 0.16);
}
.k-chip-solid-warning.k-selected {
  background-color: rgba(255, 184, 46, 0.24);
}
.k-chip-solid-error {
  border-color: rgba(255, 38, 55, 0.3);
  color: #ff2637;
  background-color: rgba(255, 38, 55, 0.08);
}
.k-chip-solid-error:hover,
.k-chip-solid-error.k-hover {
  background-color: rgba(255, 38, 55, 0.16);
}
.k-chip-solid-error:focus,
.k-chip-solid-error.k-focus {
  box-shadow: 0 0 0 2px rgba(255, 38, 55, 0.16);
}
.k-chip-solid-error.k-selected {
  background-color: rgba(255, 38, 55, 0.24);
}
.k-chip-solid-info {
  border-color: rgba(30, 162, 179, 0.3);
  color: #1ea2b3;
  background-color: rgba(30, 162, 179, 0.08);
}
.k-chip-solid-info:hover,
.k-chip-solid-info.k-hover {
  background-color: rgba(30, 162, 179, 0.16);
}
.k-chip-solid-info:focus,
.k-chip-solid-info.k-focus {
  box-shadow: 0 0 0 2px rgba(30, 162, 179, 0.16);
}
.k-chip-solid-info.k-selected {
  background-color: rgba(30, 162, 179, 0.24);
}
.k-chip-outline-base {
  border-color: #9da2a4;
  color: #9da2a4;
...
.k-chip-outline-base.k-focus {
  box-shadow: 0 0 0 2px rgba(157, 162, 164, 0.08);
}
...
.k-panelbar .k-panelbar-group > .k-panelbar-item > .k-link.k-selected.k-hover {
  background-color: rgba(17, 91, 101, 0.325);
}
...
.k-no-color .k-color-preview-mask::before {
  content: "";
  background-image: url('data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2220%22%20height%3D%2220%22%20version%3D%221.1%22%3E%3Cline%20x1%3D%220%22%20x2%3D%2220%22%20y1%3D%220%22%20y2%3D%2220%22%20stroke%3D%22%23ff2637%22%20stroke-width%3D%221%22/%3E%3C/svg%3E');
  background-color: white;
...
.k-grid-header,
.k-grouping-header,
.k-state-highlight:not(.k-panelbar-item) {
  color: #ffffff;
  background-color: #ff4350;
  border-color: #ff4350;
}
...
.k-tabstrip-left > .k-tabstrip-items-wrapper > .k-tabstrip-items > .k-item.k-state-active,
.k-tabstrip-left > .k-tabstrip-items-wrapper > .k-tabstrip-items > .k-item.k-active {
  border-right-color: #ff4350;
}
.k-tabstrip-right > .k-tabstrip-items-wrapper > .k-tabstrip-items > .k-item.k-state-active,
.k-tabstrip-right > .k-tabstrip-items-wrapper > .k-tabstrip-items > .k-item.k-active {
...
.k-tabstrip-bottom > .k-tabstrip-items-wrapper > .k-tabstrip-items > .k-item.k-state-active,
.k-tabstrip-bottom > .k-tabstrip-items-wrapper > .k-tabstrip-items > .k-item.k-active {
  border-top-color: #ff4350;
}
...
.k-progressbar-horizontal .k-selected.k-first {
  border-left-color: #ff4350;
}
.k-progressbar-horizontal .k-state-selected.k-last,
.k-progressbar-horizontal .k-selected.k-last {
  border-right-color: #ff4350;
}
...
.k-progressbar-vertical .k-selected.k-first {
  border-top-color: #ff4350;
}
.k-progressbar-vertical .k-state-selected.k-last,
.k-progressbar-vertical .k-selected.k-last {
  border-bottom-color: #ff4350;
}
.k-grid-header,
...
.k-grid td.k-state-selected.k-focus,
...
.k-grid tr:hover .k-focus.k-state-selected,
.k-grid tr:hover .k-state-focused.k-selected,
.k-grid tr:hover .k-focus.k-selected,
.k-grid tr.k-state-selected:hover td.k-state-focused,
.k-grid tr.k-state-selected:hover td.k-focus,
...
.k-master-row.k-state-selected.k-hover .k-grid-content-sticky,
.k-master-row.k-selected.k-state-hover .k-grid-content-sticky,
