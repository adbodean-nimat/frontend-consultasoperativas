...
.k-button-solid-secondary.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(0, 91, 158, 0.75);
}
...
.k-button-solid-tertiary.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(0, 110, 18, 0.75);
}
...
.k-button-solid-info.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(20, 94, 168, 0.75);
}
...
.k-button-solid-success.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(54, 128, 57, 0.75);
}
...
.k-button-solid-warning.k-hover {
  border-color: #b39903;
  background-color: #e6c504;
}
.k-button-solid-warning:focus,
.k-button-solid-warning.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(204, 175, 3, 0.75);
}
...
.k-button-solid-error.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(195, 54, 43, 0.75);
}
...
.k-button-outline-primary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(205, 230, 247, 0.75);
}
...
.k-button-outline-secondary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(0, 114, 198, 0.75);
}
...
.k-button-outline-tertiary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(0, 138, 23, 0.75);
}
...
.k-button-outline-info.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(25, 118, 210, 0.75);
}
...
.k-button-outline-success.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(67, 160, 71, 0.75);
}
...
.k-button-outline-warning.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(255, 219, 4, 0.75);
}
...
.k-button-outline-error.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(244, 67, 54, 0.75);
}
...
.k-timeline-track-item.k-focus .k-timeline-circle {
  box-shadow: 0 3px 4px 0 rgba(205, 230, 247, 0.4);
}
.k-breadcrumb:focus,
...
.k-fab-solid-primary:active {
  border-color: #a1d0f0;
  background-color: #a1d0f0;
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(205, 230, 247, 0.4);
}
...
.k-fab-solid-secondary:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(0, 114, 198, 0.4);
}
...
.k-fab-solid-tertiary:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(0, 138, 23, 0.4);
}
...
.k-fab-solid-info:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(25, 118, 210, 0.4);
}
...
.k-fab-solid-success:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(67, 160, 71, 0.4);
}
...
.k-fab-solid-warning:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(255, 219, 4, 0.4);
}
...
.k-fab-solid-error:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(244, 67, 54, 0.4);
}
...
.k-bottom-nav-solid.k-bottom-nav-primary .k-bottom-nav-item:focus {
  background-color: rgba(72, 81, 86, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-secondary .k-bottom-nav-item:focus {
  background-color: rgba(166, 206, 235, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-tertiary .k-bottom-nav-item:focus {
  background-color: rgba(166, 214, 174, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-info .k-bottom-nav-item:focus {
  background-color: rgba(175, 207, 239, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-success .k-bottom-nav-item:focus {
  background-color: rgba(189, 222, 191, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-warning .k-bottom-nav-item:focus {
  background-color: rgba(89, 77, 1, 0.2);
}
...
.k-pivotgrid-row.k-selected > .k-pivotgrid-cell {
  background-color: rgba(205, 230, 247, 0.25);
}
...
.k-chip-solid-success.k-hover {
  background-color: rgba(67, 160, 71, 0.16);
}
.k-chip-solid-success:focus,
.k-chip-solid-success.k-focus {
  box-shadow: 0 0 0 2px rgba(67, 160, 71, 0.16);
}
.k-chip-solid-success.k-selected {
  background-color: rgba(67, 160, 71, 0.24);
}
.k-chip-solid-warning {
  border-color: rgba(255, 219, 4, 0.3);
  color: #ffdb04;
  background-color: rgba(255, 219, 4, 0.08);
}
.k-chip-solid-warning:hover,
.k-chip-solid-warning.k-hover {
  background-color: rgba(255, 219, 4, 0.16);
}
.k-chip-solid-warning:focus,
.k-chip-solid-warning.k-focus {
  box-shadow: 0 0 0 2px rgba(255, 219, 4, 0.16);
}
.k-chip-solid-warning.k-selected {
  background-color: rgba(255, 219, 4, 0.24);
}
.k-chip-solid-error {
...
.k-panelbar > li > .k-state-focused.k-hover,
.k-panelbar > li > .k-focus.k-state-hover,
...
.k-progressbar.k-progressbar-vertical .k-selected {
  border-color: #0072c6;
}
.k-tabstrip .k-item {
  background-color: #f4f4f4;
...
.k-panelbar .k-state-selected.k-hover,
.k-panelbar .k-selected.k-state-hover,
.k-panelbar .k-selected.k-hover {
  background-color: #cde6f7;
  color: #000;
}
.k-panelbar,
...
.k-mediaplayer .k-toolbar .k-icon-button,
.k-mediaplayer .k-toolbar .k-button.k-button-icon {
  margin-top: 0.2em;
}
...
.k-spreadsheet .k-spreadsheet-tabstrip {
  padding: 4px 0 0;
  color: #000000;
  background-color: #f4f4f4;
}
