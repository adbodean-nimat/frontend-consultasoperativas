...
.k-floating-label-container.k-focus > .k-label {
  -webkit-transform: translate(-12px, -6px) translate(-1px, -1.0714285725em) translate(-12.5%, -12.5%) scale(0.75);
      -ms-transform: translate(-12px, -6px) translate(-1px, -1.0714285725em) translate(-12.5%, -12.5%) scale(0.75);
          transform: translate(-12px, -6px) translate(-1px, -1.0714285725em) translate(-12.5%, -12.5%) scale(0.75);
}
...
.k-floating-label-container[dir='rtl'].k-focus > .k-label {
  -webkit-transform: translate(12px, -4.5px) translate(1px, -1.0714285725) translate(12.5%, -9.375%) scale(0.75);
      -ms-transform: translate(12px, -4.5px) translate(1px, -1.0714285725) translate(12.5%, -9.375%) scale(0.75);
          transform: translate(12px, -4.5px) translate(1px, -1.0714285725) translate(12.5%, -9.375%) scale(0.75);
}
.k-input-label {
  margin-right: 12px;
  z-index: 1;
