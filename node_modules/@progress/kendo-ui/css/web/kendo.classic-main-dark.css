...
.k-button-solid-base.k-focus {
  box-shadow: 0 0 4px 0 rgba(54, 54, 54, 0.75);
}
...
.k-button-solid-primary.k-focus {
  box-shadow: 0 0 4px 0px rgba(245, 115, 41, 0.75);
}
...
.k-button-solid-secondary.k-focus {
  box-shadow: 0 0 4px 0px rgba(237, 237, 237, 0.75);
}
...
.k-button-solid-tertiary.k-focus {
  box-shadow: 0 0 4px 0px rgba(43, 183, 246, 0.75);
}
.k-button-solid-tertiary:active,
.k-button-solid-tertiary.k-active {
  border-color: #54c5f8;
  background-color: #2bb7f6;
}
...
.k-button-solid-info.k-focus {
  box-shadow: 0 0 4px 0px rgba(41, 144, 205, 0.75);
}
...
.k-button-solid-success.k-hover {
  border-color: #6cba78;
  background-color: #4dab5c;
}
.k-button-solid-success:focus,
.k-button-solid-success.k-focus {
  box-shadow: 0 0 4px 0px rgba(93, 179, 106, 0.75);
}
...
.k-button-solid-warning.k-focus {
  box-shadow: 0 0 4px 0px rgba(255, 168, 41, 0.75);
}
...
.k-button-solid-error.k-focus {
  box-shadow: 0 0 4px 0px rgba(223, 74, 41, 0.75);
}
...
.k-button-solid-dark.k-focus {
  box-shadow: 0 0 4px 0px rgba(95, 95, 95, 0.75);
}
...
.k-button-solid-light.k-focus {
  box-shadow: 0 0 4px 0px rgba(238, 238, 238, 0.75);
}
...
.k-menu:not(.k-context-menu) > .k-item.k-focus {
  box-shadow: inset 0 0 3px 1px rgba(255, 255, 255, 0.25);
}
.k-menu-group,
...
.k-slider .k-draghandle.k-focus {
  box-shadow: 0 0 4px 0 rgba(245, 115, 41, 0.75);
}
...
.k-calendar-infinite .k-calendar-view::after {
  ...
  width: 150%;
  left: -25%;
  box-shadow: 0 0 32px 16px #202020;
}
...
.k-time-list::before,
.k-time-list::after {
  box-shadow: 0 0 3em 1.5em #202020;
}
...
.k-switch-off.k-focus .k-switch-track {
  outline: 0 0 3px 1px rgba(255, 255, 255, 0.25);
}
...
.k-fab-solid-primary:disabled {
  box-shadow: 0 6px 10px rgba(0, 0, 0, 0.1744), 0 1px 18px rgba(0, 0, 0, 0.1552), 0 3px 5px rgba(0, 0, 0, 0.232);
...
.k-grid .k-grid-content-locked .k-selected.k-alt td {
  background-color: rgba(255, 134, 126, 0.28);
}
.k-grid .k-grid-content-locked .k-state-selected:hover td,
.k-grid .k-grid-content-locked .k-selected:hover td,
.k-grid .k-grid-content-locked .k-state-selected.k-state-hover td,
.k-grid .k-grid-content-locked .k-selected.k-hover td {
  background-color: rgba(255, 158, 151, 0.31);
}
.k-grid .k-grid-header-locked .k-header {
...
.k-task-milestone.k-task-delayed {
  background-image: repeating-linear-gradient(90deg, #000000, #000000 2px, #d92800 2px, #d92800 4px);
}
...
.k-task-offset {
  background-image: repeating-linear-gradient(135deg, #000000, #000000 2px, #d92800 2px, #d92800 4px);
}
...
.k-task-offset:hover {
  background-image: repeating-linear-gradient(135deg, #000000, #000000 2px, #e87e66 2px, #e87e66 4px);
}
...
.k-treemap .k-leaf.k-hover {
  box-shadow: inset 0 0 0 3px #363636;
}
.k-map {
  height: 600px;
  box-sizing: border-box;
