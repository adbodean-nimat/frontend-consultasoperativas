...
.k-button-solid-tertiary.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(122, 167, 1, 0.75);
}
...
.k-button-solid-info.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(45, 131, 204, 0.75);
}
...
.k-button-solid-success.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(79, 147, 108, 0.75);
}
.k-button-solid-success:active,
.k-button-solid-success.k-active,
.k-button-solid-success.k-selected {
  border-color: #3b6e51;
  background-color: #4f936c;
}
...
.k-button-solid-warning.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(201, 157, 46, 0.75);
}
...
.k-button-solid-error.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(204, 50, 50, 0.75);
}
...
.k-button-outline-primary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(0, 124, 192, 0.75);
}
...
.k-button-outline-tertiary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(153, 209, 1, 0.75);
}
...
.k-button-outline-info.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(56, 164, 255, 0.75);
}
...
.k-button-outline-success.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(99, 184, 135, 0.75);
}
...
.k-button-outline-warning.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(251, 196, 58, 0.75);
}
...
.k-button-outline-error.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(255, 62, 62, 0.75);
}
...
.k-no-color .k-color-preview-mask::before {
  content: "";
  background-image: url('data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2220%22%20height%3D%2220%22%20version%3D%221.1%22%3E%3Cline%20x1%3D%220%22%20x2%3D%2220%22%20y1%3D%220%22%20y2%3D%2220%22%20stroke%3D%22%23ff3e3e%22%20stroke-width%3D%221%22/%3E%3C/svg%3E');
  background-color: white;
...
.k-group > .k-item > .k-selected,
.k-group > .k-item > .k-link.k-state-selected,
.k-group > .k-item > .k-link.k-selected,
.k-group > .k-item > .k-link.k-state-selected.k-state-hover,
.k-group > .k-item > .k-link.k-state-selected.k-hover,
.k-group > .k-item > .k-link.k-selected.k-state-hover,
.k-group > .k-item > .k-link.k-selected.k-hover,
.k-gantt .k-treelist .k-state-selected,
.k-gantt .k-treelist .k-selected,
.k-gantt .k-treelist .k-state-selected td,
.k-gantt .k-treelist .k-selected td,
