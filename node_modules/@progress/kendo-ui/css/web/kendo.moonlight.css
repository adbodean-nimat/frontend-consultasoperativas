...
.k-button-solid-base.k-focus {
  border-color: #f4af03;
  box-shadow: 0 0 4px 0px rgba(244, 175, 3, 0.75);
}
...
.k-button-solid-secondary.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(26, 34, 41, 0.75);
}
...
.k-button-solid-tertiary.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(204, 162, 6, 0.75);
}
...
.k-button-solid-info.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(10, 95, 124, 0.75);
}
...
.k-button-solid-error.k-hover {
  border-color: #853927;
  background-color: #ab4932;
}
.k-button-solid-error:focus,
.k-button-solid-error.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(152, 65, 45, 0.75);
}
...
.k-button-outline-primary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(244, 175, 3, 0.75);
}
...
.k-button-outline-secondary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(33, 42, 51, 0.75);
}
...
.k-button-outline-tertiary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(255, 202, 8, 0.75);
}
...
.k-button-outline-info.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(12, 119, 155, 0.75);
}
...
.k-button-outline-warning.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(234, 157, 7, 0.75);
}
...
.k-button-outline-error.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(190, 81, 56, 0.75);
}
...
.k-card.k-focus {
  ...
  box-shadow: 0 3px 4px 0 rgba(255, 255, 255, 0.6);
}
.k-card-header {
  border-color: #232d36;
  color: #ffffff;
...
.k-card.k-focus .k-card-callout.k-callout-n {
  box-shadow: 1px -1px 4px 0 rgba(255, 255, 255, 0.6);
}
...
.k-card.k-focus .k-card-callout.k-callout-e {
  box-shadow: 2px -1px 4px 0 rgba(255, 255, 255, 0.6);
}
...
.k-card.k-focus .k-card-callout.k-callout-s {
  box-shadow: 2px -2px 4px 0 rgba(255, 255, 255, 0.6);
}
...
.k-calendar td.k-focus .k-link {
  box-shadow: inset 0 0 4px 0px rgba(244, 175, 3, 0.75);
}
...
.k-switch-off .k-switch-thumb {
  ...
  background-color: #212a33;
  background-image: url("textures/brushed-metal.png");
  background-image: url("textures/brushed-metal.png"), linear-gradient(to bottom, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0));
}
.k-switch-off:focus,
...
.k-fab-solid-primary:active {
  border-color: #c28b02;
  background-color: #c28b02;
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(244, 175, 3, 0.4);
}
...
.k-fab-solid-secondary:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(33, 42, 51, 0.4);
}
...
.k-fab-solid-tertiary:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(255, 202, 8, 0.4);
}
...
.k-fab-solid-info:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(12, 119, 155, 0.4);
}
...
.k-fab-solid-warning:active {
  border-color: #b87c06;
  background-color: #b87c06;
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(234, 157, 7, 0.4);
}
...
.k-fab-solid-error:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(190, 81, 56, 0.4);
}
...
.k-fab-item:active .k-fab-item-icon {
  border-color: #050608;
  background-color: #2d3946;
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(65, 83, 101, 0.4);
}
...
.k-bottom-nav-solid.k-bottom-nav-primary .k-bottom-nav-item:focus {
  background-color: rgba(85, 61, 1, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-secondary .k-bottom-nav-item:focus {
  background-color: rgba(177, 180, 184, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-tertiary .k-bottom-nav-item:focus {
  background-color: rgba(89, 71, 3, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-info .k-bottom-nav-item:focus {
  background-color: rgba(170, 207, 220, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-warning .k-bottom-nav-item:focus {
  background-color: rgba(248, 221, 168, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-error .k-bottom-nav-item:focus {
  background-color: rgba(232, 194, 185, 0.2);
}
...
.k-pivotgrid-row.k-selected > .k-pivotgrid-cell {
  background-color: rgba(244, 175, 3, 0.25);
}
...
.k-chip-solid-warning {
  border-color: rgba(234, 157, 7, 0.3);
  color: #ea9d07;
  background-color: rgba(234, 157, 7, 0.08);
}
.k-chip-solid-warning:hover,
.k-chip-solid-warning.k-hover {
  background-color: rgba(234, 157, 7, 0.16);
}
.k-chip-solid-warning:focus,
.k-chip-solid-warning.k-focus {
  box-shadow: 0 0 0 2px rgba(234, 157, 7, 0.16);
}
.k-chip-solid-warning.k-selected {
  background-color: rgba(234, 157, 7, 0.24);
}
.k-chip-solid-error {
  border-color: rgba(190, 81, 56, 0.3);
  color: #be5138;
  background-color: rgba(190, 81, 56, 0.08);
}
.k-chip-solid-error:hover,
.k-chip-solid-error.k-hover {
  background-color: rgba(190, 81, 56, 0.16);
}
.k-chip-solid-error:focus,
.k-chip-solid-error.k-focus {
  box-shadow: 0 0 0 2px rgba(190, 81, 56, 0.16);
}
.k-chip-solid-error.k-selected {
  background-color: rgba(190, 81, 56, 0.24);
}
.k-chip-solid-info {
  border-color: rgba(12, 119, 155, 0.3);
  color: #0c779b;
  background-color: rgba(12, 119, 155, 0.08);
}
.k-chip-solid-info:hover,
.k-chip-solid-info.k-hover {
  background-color: rgba(12, 119, 155, 0.16);
}
.k-chip-solid-info:focus,
.k-chip-solid-info.k-focus {
  box-shadow: 0 0 0 2px rgba(12, 119, 155, 0.16);
}
.k-chip-solid-info.k-selected {
  background-color: rgba(12, 119, 155, 0.24);
}
.k-chip-outline-base {
  border-color: #fff;
  color: #fff;
...
.k-no-color .k-color-preview-mask::before {
  content: "";
  background-image: url('data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2220%22%20height%3D%2220%22%20version%3D%221.1%22%3E%3Cline%20x1%3D%220%22%20x2%3D%2220%22%20y1%3D%220%22%20y2%3D%2220%22%20stroke%3D%22%23be5138%22%20stroke-width%3D%221%22/%3E%3C/svg%3E');
  background-color: white;
