...
.k-fab-solid-primary:focus {
  outline-style: solid;
  outline-width: 2px;
  outline-color: rgba(123, 210, 246, 0.3);
}
.k-fab-solid-secondary.k-focus,
.k-fab-solid-secondary:focus {
  outline-style: solid;
  outline-width: 2px;
  outline-color: rgba(218, 236, 244, 0.3);
}
...
.k-grid .k-grid-content-locked .k-selected.k-alt td {
  background-color: rgba(95, 163, 190, 0.28);
}
.k-grid .k-grid-content-locked .k-state-selected:hover td,
.k-grid .k-grid-content-locked .k-selected:hover td,
.k-grid .k-grid-content-locked .k-state-selected.k-state-hover td,
.k-grid .k-grid-content-locked .k-selected.k-hover td {
  background-color: rgba(76, 131, 153, 0.31);
}
.k-grid .k-grid-header-locked .k-header {
...
.k-spreadsheet-active-cell.k-right {
  box-shadow: inset 0 0 0 1px #7bd2f6, inset -1px 0 0 1px #7bd2f6;
}
.k-spreadsheet-active-cell.k-bottom {
  box-shadow: inset 0 0 0 1px #7bd2f6, inset 0 -1px 0 1px #7bd2f6;
}
.k-spreadsheet-active-cell.k-bottom.k-right {
  box-shadow: inset 0 0 0 1px #7bd2f6, inset -1px -1px 0 1px #7bd2f6;
}
.k-spreadsheet .k-auto-fill {
  border-color: #7bd2f6;
  background-color: rgba(123, 210, 246, 0.25);
...
.k-spreadsheet-has-comment::after {
  border-color: #7bd2f6 #7bd2f6 transparent transparent;
}
.k-dirty {
...
[dir="rtl"] .k-spreadsheet .k-spreadsheet-has-comment::after {
  border-color: #7bd2f6 transparent transparent #7bd2f6;
}
.k-rtl .k-spreadsheet .k-dirty,
.k-spreadsheet[dir="rtl"] .k-dirty,
...
.k-chat .k-alt .k-bubble {
  ...
  color: black;
  background-color: #7bd2f6;
  box-shadow: 0 1px 2px rgba(123, 210, 246, 0.2);
}
...
.k-chat .k-alt .k-selected .k-bubble {
  box-shadow: 0 3px 10px rgba(123, 210, 246, 0.4);
}
...
.k-timeline-track-item.k-focus .k-timeline-circle {
  box-shadow: 0 3px 4px 0 rgba(123, 210, 246, 0.4);
}
.k-pdf-viewer {
  border-width: 1px;
  border-style: solid;
