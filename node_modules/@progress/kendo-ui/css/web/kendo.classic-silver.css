...
.k-checkbox.k-indeterminate {
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%231984c8' stroke-linecap='square' stroke-linejoin='square' stroke-width='2' d='M4,8 h8'/%3e%3c/svg%3e");
}
.k-checkbox:disabled,
...
.k-checkbox.k-checked.k-focus {
  box-shadow: 0 0 0 2px rgba(25, 132, 200, 0.3);
}
...
.k-button-solid-primary.k-focus {
  box-shadow: 0 0 4px 0px rgba(21, 111, 168, 0.75);
}
...
.k-button-solid-secondary.k-focus {
  box-shadow: 0 0 4px 0px rgba(204, 204, 205, 0.75);
}
...
.k-button-outline-secondary.k-focus {
  box-shadow: 0 0 4px 0px rgba(243, 243, 244, 0.75);
}
...
.k-button-outline-base.k-focus {
  box-shadow: 0 0 4px 0px rgba(81, 89, 103, 0.75);
}
...
.k-input-outline {
  border-color: rgba(81, 89, 103, 0.5);
}
...
.k-input-outline.k-hover {
  border-color: rgba(81, 89, 103, 0.8);
}
...
.k-picker-flat.k-hover {
  border-color: rgba(204, 204, 205, 0.16);
  background-color: rgba(81, 89, 103, 0.04);
}
.k-picker-flat:focus,
...
.k-menu:not(.k-context-menu) > .k-item.k-focus {
  box-shadow: inset 0 0 3px 1px rgba(81, 89, 103, 0.25);
}
.k-menu-group,
...
.k-slider .k-draghandle.k-focus {
  box-shadow: 0 0 4px 0 rgba(21, 111, 168, 0.75);
}
...
.k-calendar .k-range-split-start::after {
  left: -5px;
  right: auto;
  background-image: linear-gradient(to left, rgba(25, 132, 200, 0.25), transparent 100%);
}
.k-calendar .k-range-split-end::after {
  right: -5px;
  left: auto;
  background-image: linear-gradient(to right, rgba(25, 132, 200, 0.25), transparent 100%);
}
.k-timeselector {
  border-width: 1px;
  border-style: solid;
...
.k-fab-solid-primary:focus {
  outline-style: solid;
  outline-width: 2px;
  outline-color: rgba(25, 132, 200, 0.3);
}
.k-fab-solid-secondary.k-focus,
.k-fab-solid-secondary:focus {
  outline-style: solid;
  outline-width: 2px;
  outline-color: rgba(243, 243, 244, 0.3);
}
...
.k-fab-solid-info:focus {
  outline-style: solid;
  outline-width: 2px;
  outline-color: rgba(0, 123, 195, 0.3);
}
...
.k-stepper .k-step-link:focus .k-step-label:only-child {
  box-shadow: inset 0 0 0 2px #cccccd;
}
.k-stepper .k-step-label-optional {
  color: #666666;
}
...
.k-grouping-dropclue::before {
  border-color: #515967 transparent transparent;
}
.k-grouping-dropclue::after {
  background-color: #515967;
}
...
.k-grid .k-grid-content-locked .k-selected.k-alt td {
  background-color: rgba(19, 102, 155, 0.28);
}
.k-grid .k-grid-content-locked .k-state-selected:hover td,
.k-grid .k-grid-content-locked .k-selected:hover td,
.k-grid .k-grid-content-locked .k-state-selected.k-state-hover td,
.k-grid .k-grid-content-locked .k-selected.k-hover td {
  background-color: rgba(16, 82, 124, 0.31);
}
.k-grid .k-grid-header-locked .k-header {
...
.k-spreadsheet-drawing-anchor-cell {
  background: rgba(25, 132, 200, 0.25);
}
.k-rtl .k-spreadsheet .k-spreadsheet-has-comment::after,
.k-spreadsheet[dir="rtl"] .k-spreadsheet-has-comment::after,
...
.k-chat .k-alt .k-bubble {
  ...
  color: white;
  background-color: #1984c8;
  box-shadow: 0 1px 2px rgba(25, 132, 200, 0.2);
}
...
.k-chat .k-alt .k-selected .k-bubble {
  box-shadow: 0 3px 10px rgba(25, 132, 200, 0.4);
}
...
.k-mediaplayer-titlebar {
  color: #ffffff;
  background-image: linear-gradient(rgba(81, 89, 103, 0.7), rgba(81, 89, 103, 0));
  text-shadow: 0 0 2px rgba(81, 89, 103, 0.5);
}
.k-timeline {
  box-sizing: border-box;
  outline: 0;
...
.k-timeline-track-item.k-focus .k-timeline-circle {
  box-shadow: 0 3px 4px 0 rgba(25, 132, 200, 0.4);
}
.k-pdf-viewer {
  border-width: 1px;
  border-style: solid;
...
.k-var--chart-inactive {
  background-color: rgba(81, 89, 103, 0.5);
}
...
.k-treemap .k-leaf.k-hover {
  box-shadow: inset 0 0 0 3px #cccccd;
}
.k-map {
  height: 600px;
  box-sizing: border-box;
