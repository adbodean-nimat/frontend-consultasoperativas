...
.k-dirty {
  ...
  border-width: 3px;
  border-style: solid;
  border-color: #d31038 #d31038 transparent transparent;
  position: absolute;
  top: 0;
  right: 0;
}
[dir="rtl"] .k-dirty,
.k-rtl .k-dirty {
  border-color: transparent transparent #d31038 #d31038;
  right: auto;
  left: 0;
}
.k-placeholder-line {
...
.k-border-primary {
  border-color: #e7607b !important;
}
.k-border-secondary {
  border-color: #d6e5e9 !important;
}
.k-border-tertiary {
  border-color: #6f42c1 !important;
}
.k-border-info {
  border-color: #01a8c1 !important;
}
.k-border-success {
  border-color: #90bf4f !important;
}
.k-border-warning {
  border-color: #ffc857 !important;
}
.k-border-error {
  border-color: #d31038 !important;
}
.k-border-dark {
...
.k-bg-success {
  background-color: #90bf4f !important;
}
.k-bg-warning {
...
.k-checkbox.k-focus {
  border-color: #f3b0bd;
  box-shadow: 0 0 0 0.25rem rgba(231, 96, 123, 0.25);
}
.k-checkbox:indeterminate,
.k-checkbox.k-indeterminate {
  border-color: #e7607b;
...
.k-button-solid-base.k-focus {
  box-shadow: 0 0 0 0.25rem rgba(214, 229, 233, 0.5);
}
...
.k-button-solid-primary.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(231, 96, 123, 0.5);
}
...
.k-button-solid-secondary.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(214, 229, 233, 0.5);
}
...
.k-button-solid-info.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(1, 168, 193, 0.5);
}
...
.k-button-solid-success.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(144, 191, 79, 0.5);
}
...
.k-button-solid-warning.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(255, 200, 87, 0.5);
}
...
.k-button-solid-error.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(211, 16, 56, 0.5);
}
...
.k-button-outline-base.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(41, 43, 44, 0.5);
}
...
.k-input-solid.ng-invalid.ng-dirty.k-focus {
  box-shadow: 0 0 0 0.25rem rgba(211, 16, 56, 0.25);
}
...
.k-table-list .k-table-row.k-selected {
  border-color: #dee2e6;
  color: #292b2c;
  background-color: rgba(231, 96, 123, 0.25);
}
.k-virtual-scroller {
  width: 100%;
  height: 100%;
...
.k-chip-solid-base.k-focus {
  box-shadow: 0 0 0 2px rgba(41, 43, 44, 0.16);
  background-color: #eeeeee;
}
...
.k-chip-solid-error.k-focus {
  box-shadow: 0 0 0 2px rgba(211, 16, 56, 0.16);
  background-color: #fbecef;
}
...
.k-chip-solid-info.k-focus {
  box-shadow: 0 0 0 2px rgba(1, 168, 193, 0.16);
  background-color: #ebf8fa;
}
...
.k-chip-solid-success.k-focus {
  box-shadow: 0 0 0 2px rgba(144, 191, 79, 0.16);
  background-color: #f6faf1;
}
...
.k-no-color .k-color-preview-mask::before {
  content: "";
  background-color: #ffffff;
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='20' height='20' version='1.1'%3e%3cline x1='0' x2='20' y1='0' y2='20' stroke='%23d31038' stroke-width='1'/%3e%3c/svg%3e");
...
.k-slider .k-draghandle.k-focus {
  box-shadow: 0 0 0 3px rgba(231, 96, 123, 0.5);
}
...
.k-calendar .k-calendar-view .k-today .k-link {
  box-shadow: inset 0 0 0 1px #e7607b;
}
...
.k-calendar .k-calendar-view .k-today.k-state-focused .k-link {
  box-shadow: inset 0 0 0 1px #e7607b, inset 0 0 0 0.25rem rgba(214, 229, 233, 0.5);
}
...
.k-calendar .k-calendar-td.k-state-focused .k-link {
  box-shadow: inset 0 0 0 0.25rem rgba(214, 229, 233, 0.5);
}
...
.k-calendar .k-calendar-td.k-state-selected.k-state-focus .k-link {
  box-shadow: inset 0 0 0 2px rgba(223, 41, 77, 0.5);
}
...
.k-calendar .k-range-split-start::after {
  left: -5px;
  right: auto;
  background-image: linear-gradient(to left, rgba(231, 96, 123, 0.25), transparent 100%);
}
.k-calendar .k-range-split-end::after {
  right: -5px;
  left: auto;
  background-image: linear-gradient(to right, rgba(231, 96, 123, 0.25), transparent 100%);
}
.k-timeselector {
  border-width: 1px;
  border-style: solid;
...
.k-treeview-leaf.k-focus {
  box-shadow: inset 0 0 0 2px rgba(41, 43, 44, 0.15);
}
...
.k-switch-off.k-focus .k-switch-track {
  border-color: #f3b0bd;
  outline: 0.25rem solid rgba(231, 96, 123, 0.25);
}
...
.k-upload .k-file-error .k-file-extension-wrapper::before {
  background-color: #ffffff;
  border-color: transparent transparent #8f9ea2 #8f9ea2;
}
.k-upload .k-multiple-files-extension-wrapper::after,
.k-upload .k-multiple-files-invalid-extension-wrapper::after {
  border-top-color: #8f9ea2;
  border-left-color: #8f9ea2;
}
...
.k-fab-solid-primary:focus {
  outline-style: solid;
  outline-width: 3px;
  outline-color: rgba(231, 96, 123, 0.5);
}
.k-fab-solid-secondary.k-focus,
.k-fab-solid-secondary:focus {
  outline-style: solid;
  outline-width: 3px;
  outline-color: rgba(214, 229, 233, 0.5);
}
...
.k-bottom-nav-solid.k-bottom-nav-primary .k-bottom-nav-item:focus {
  background-color: rgba(247, 199, 209, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-secondary .k-bottom-nav-item:focus {
  background-color: rgba(75, 80, 82, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-info .k-bottom-nav-item:focus {
  background-color: rgba(166, 225, 233, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-success .k-bottom-nav-item:focus {
  background-color: rgba(216, 233, 193, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-warning .k-bottom-nav-item:focus {
  background-color: rgba(89, 70, 30, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-error .k-bottom-nav-item:focus {
  background-color: rgba(240, 171, 185, 0.2);
}
...
.k-focus.k-pager-refresh {
  background-color: #ffffff;
  box-shadow: 0 0 0 3px rgba(231, 96, 123, 0.25);
}
.k-pager-numbers .k-link {
  border-color: #dee2e6;
  color: #e7607b;
...
.k-grid-header .k-grid-header-sticky.k-sorted {
  color: #292b2c;
  background-color: #f8f9fa;
  border-right-color: rgba(41, 43, 44, 0.5);
  border-left-color: rgba(41, 43, 44, 0.5);
}
...
.k-master-row .k-grid-row-sticky {
  border-top-color: rgba(41, 43, 44, 0.5);
  border-bottom-color: rgba(41, 43, 44, 0.5);
  background-color: #ffffff;
}
...
.k-spreadsheet-active-cell.k-right {
  box-shadow: inset 0 0 0 1px #e7607b, inset -1px 0 0 1px #e7607b;
}
.k-spreadsheet-active-cell.k-bottom {
  box-shadow: inset 0 0 0 1px #e7607b, inset 0 -1px 0 1px #e7607b;
}
.k-spreadsheet-active-cell.k-bottom.k-right {
  box-shadow: inset 0 0 0 1px #e7607b, inset -1px -1px 0 1px #e7607b;
}
.k-spreadsheet .k-auto-fill {
  border-color: #e7607b;
  background-color: rgba(231, 96, 123, 0.25);
...
.k-spreadsheet-has-comment::after {
  border-color: #e7607b #e7607b transparent transparent;
}
.k-dirty {
  border-color: #d31038 transparent transparent #d31038;
}
.k-spreadsheet .k-filter-range {
  border-color: #e7607b;
}
.k-spreadsheet-filter {
  ...
  color: #212529;
  background-color: #d6e5e9;
  box-shadow: inset 0 0 0 1px #d6e5e9;
}
...
.k-spreadsheet-drawing-anchor-cell {
  background: rgba(231, 96, 123, 0.25);
}
...
[dir="rtl"] .k-spreadsheet .k-spreadsheet-has-comment::after {
  border-color: #e7607b transparent transparent #e7607b;
}
.k-rtl .k-spreadsheet .k-dirty,
.k-spreadsheet[dir="rtl"] .k-dirty,
...
.k-task-milestone.k-task-delayed {
  background-image: repeating-linear-gradient(90deg, #ffffff, #ffffff 2px, #d31038 2px, #d31038 4px);
}
...
.k-task-offset {
  background-image: repeating-linear-gradient(135deg, #ffffff, #ffffff 2px, #d31038 2px, #d31038 4px);
}
...
.k-task-offset:hover {
  background-image: repeating-linear-gradient(135deg, #ffffff, #ffffff 2px, #e57088 2px, #e57088 4px);
}
...
.k-var--chart-inactive {
  background-color: rgba(80, 104, 110, 0.5);
}
...
.k-signature .k-signature-line {
  border-bottom-color: rgba(1, 168, 193, 0.24);
}
