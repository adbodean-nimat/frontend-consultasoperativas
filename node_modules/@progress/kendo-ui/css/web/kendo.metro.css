...
.k-button-solid-tertiary.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(38, 124, 56, 0.75);
}
...
.k-button-outline-primary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(126, 167, 0, 0.75);
}
...
.k-button-outline-tertiary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(48, 155, 70, 0.75);
}
...
.k-fab-solid-primary:active {
  border-color: #587400;
  background-color: #587400;
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(126, 167, 0, 0.4);
}
...
.k-fab-solid-tertiary:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(48, 155, 70, 0.4);
}
...
.k-bottom-nav-solid.k-bottom-nav-primary .k-bottom-nav-item:focus {
  background-color: rgba(210, 224, 166, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-tertiary .k-bottom-nav-item:focus {
  background-color: rgba(183, 220, 190, 0.2);
}
...
.k-pivotgrid-row.k-selected > .k-pivotgrid-cell {
  background-color: rgba(126, 167, 0, 0.25);
}
