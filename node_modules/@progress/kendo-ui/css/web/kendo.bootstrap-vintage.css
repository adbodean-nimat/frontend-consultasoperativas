...
.k-dirty {
  ...
  border-width: 3px;
  border-style: solid;
  border-color: #b42a58 #b42a58 transparent transparent;
  position: absolute;
  top: 0;
  right: 0;
}
[dir="rtl"] .k-dirty,
.k-rtl .k-dirty {
  border-color: transparent transparent #b42a58 #b42a58;
  right: auto;
  left: 0;
}
.k-placeholder-line {
...
.k-border-info {
  border-color: #70c1de !important;
}
.k-border-success {
  border-color: #8dba4f !important;
}
.k-border-warning {
  border-color: #e8be68 !important;
}
.k-border-error {
  border-color: #b42a58 !important;
}
.k-border-dark {
...
.k-text-info,
.k-color-info {
  color: #70c1de !important;
}
.k-text-success,
.k-color-success {
  color: #8dba4f !important;
}
.k-text-warning,
.k-color-warning {
...
.k-bg-primary {
  background-color: #744662 !important;
}
.k-bg-secondary {
...
.k-bg-info {
  background-color: #70c1de !important;
}
.k-bg-success {
  background-color: #8dba4f !important;
}
.k-bg-warning {
  background-color: #e8be68 !important;
}
.k-bg-error {
  background-color: #b42a58 !important;
}
.k-bg-dark {
...
.k-checkbox.k-focus {
  border-color: #baa3b1;
  box-shadow: 0 0 0 0.25rem rgba(116, 70, 98, 0.25);
}
.k-checkbox:indeterminate,
.k-checkbox.k-indeterminate {
  border-color: #744662;
...
.k-focus.k-list-optionlabel {
  box-shadow: inset 0 0 0 3px rgba(73, 65, 56, 0.15);
}
...
.k-overlay-success {
  background-color: #8dba4f;
}
.k-overlay-warning {
  background-color: #e8be68;
}
.k-overlay-error {
  background-color: #b42a58;
}
.k-overlay-dark {
...
.k-button-solid-base.k-focus {
  box-shadow: 0 0 0 0.25rem rgba(218, 210, 189, 0.5);
}
...
.k-button-solid-primary.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(116, 70, 98, 0.5);
}
...
.k-button-solid-secondary.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(232, 227, 214, 0.5);
}
...
.k-button-solid-success.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(141, 186, 79, 0.5);
}
.k-button-solid-success:active,
.k-button-solid-success.k-active {
  border-color: #6c9139;
  background-color: #729a3c;
}
...
.k-button-solid-warning.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(232, 190, 104, 0.5);
}
...
.k-button-outline-base.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(73, 65, 56, 0.5);
}
...
.k-state-disabled input.k-input:disabled,
[disabled] input.k-input[disabled],
.k-disabled input.k-input[disabled],
.k-state-disabled input.k-input[disabled],
[disabled] textarea.k-textarea:disabled,
.k-disabled textarea.k-textarea:disabled,
.k-state-disabled textarea.k-textarea:disabled,
[disabled] textarea.k-textarea[disabled],
.k-disabled textarea.k-textarea[disabled],
.k-state-disabled textarea.k-textarea[disabled] {
  opacity: 1;
...
.k-input-solid.ng-invalid.ng-dirty.k-focus {
  box-shadow: 0 0 0 0.25rem rgba(180, 42, 88, 0.25);
}
.k-input-solid.k-invalid:focus-within,
.k-input-solid.ng-invalid.ng-touched:focus-within,
.k-input-solid.ng-invalid.ng-dirty:focus-within {
  box-shadow: 0 0 0 0.25rem rgba(180, 42, 88, 0.25);
}
.k-picker-solid {
  border-color: #dad2bd;
...
.k-input-outline {
  border-color: rgba(73, 65, 56, 0.5);
  color: #494138;
}
...
.k-input-outline.k-invalid:focus,
.k-input-outline.k-invalid.k-focus,
.k-input-outline.ng-invalid.ng-touched:focus,
.k-input-outline.ng-invalid.ng-touched.k-focus,
.k-input-outline.ng-invalid.ng-dirty:focus,
.k-input-outline.ng-invalid.ng-dirty.k-focus {
  box-shadow: 0 0 0 0.25rem rgba(180, 42, 88, 0.25);
}
.k-input-outline.k-invalid:focus-within,
.k-input-outline.ng-invalid.ng-touched:focus-within,
.k-input-outline.ng-invalid.ng-dirty:focus-within {
  box-shadow: 0 0 0 0.25rem rgba(180, 42, 88, 0.25);
}
.k-picker-outline {
...
.k-picker-outline.k-invalid:focus,
.k-picker-outline.k-invalid.k-focus,
.k-picker-outline.ng-invalid.ng-touched:focus,
.k-picker-outline.ng-invalid.ng-touched.k-focus,
.k-picker-outline.ng-invalid.ng-dirty:focus,
.k-picker-outline.ng-invalid.ng-dirty.k-focus {
  box-shadow: 0 0 0 0.25rem rgba(180, 42, 88, 0.25);
}
.k-picker-outline.k-invalid:focus-within,
.k-picker-outline.ng-invalid.ng-touched:focus-within,
.k-picker-outline.ng-invalid.ng-dirty:focus-within {
  box-shadow: 0 0 0 0.25rem rgba(180, 42, 88, 0.25);
}
.k-input-flat {
  border-color: #ced4da;
...
.k-input-flat.k-invalid:focus,
.k-input-flat.k-invalid.k-focus,
.k-input-flat.ng-invalid.ng-touched:focus,
.k-input-flat.ng-invalid.ng-touched.k-focus,
.k-input-flat.ng-invalid.ng-dirty:focus,
.k-input-flat.ng-invalid.ng-dirty.k-focus {
  box-shadow: 0 0 0 0.25rem rgba(180, 42, 88, 0.25);
}
.k-input-flat.k-invalid:focus-within,
.k-input-flat.ng-invalid.ng-touched:focus-within,
.k-input-flat.ng-invalid.ng-dirty:focus-within {
  box-shadow: 0 0 0 0.25rem rgba(180, 42, 88, 0.25);
}
.k-picker-flat {
  border-color: #dad2bd;
...
.k-picker-flat.k-invalid:focus,
.k-picker-flat.k-invalid.k-focus,
.k-picker-flat.ng-invalid.ng-touched:focus,
.k-picker-flat.ng-invalid.ng-touched.k-focus,
.k-picker-flat.ng-invalid.ng-dirty:focus,
.k-picker-flat.ng-invalid.ng-dirty.k-focus {
  box-shadow: 0 0 0 0.25rem rgba(180, 42, 88, 0.25);
}
.k-picker-flat.k-invalid:focus-within,
.k-picker-flat.ng-invalid.ng-touched:focus-within,
.k-picker-flat.ng-invalid.ng-dirty:focus-within {
  box-shadow: 0 0 0 0.25rem rgba(180, 42, 88, 0.25);
}
...
.k-table-list .k-table-row.k-selected {
  border-color: #dee2e6;
  color: #494138;
  background-color: rgba(116, 70, 98, 0.25);
}
.k-virtual-scroller {
  width: 100%;
  height: 100%;
...
.k-chip-solid-base.k-focus {
  box-shadow: 0 0 0 2px rgba(73, 65, 56, 0.16);
  background-color: #f0f0ef;
}
...
.k-chip-solid-error.k-focus {
  box-shadow: 0 0 0 2px rgba(180, 42, 88, 0.16);
  background-color: #f9eef2;
}
...
.k-chip-solid-info.k-focus {
  box-shadow: 0 0 0 2px rgba(112, 193, 222, 0.16);
  background-color: #f4fafc;
}
...
.k-chip-solid-warning.k-focus {
  box-shadow: 0 0 0 2px rgba(232, 190, 104, 0.16);
  background-color: #fdfaf3;
}
...
.k-chip-solid-success.k-focus {
  box-shadow: 0 0 0 2px rgba(141, 186, 79, 0.16);
  background-color: #f6f9f1;
}
...
.k-no-color .k-color-preview-mask::before {
  content: "";
  background-color: #ffffff;
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='20' height='20' version='1.1'%3e%3cline x1='0' x2='20' y1='0' y2='20' stroke='%23b42a58' stroke-width='1'/%3e%3c/svg%3e");
...
.k-ie .k-form-buttons .k-button ~ .k-button {
  margin-left: 0.5rem;
  -ms-flex-negative: 0;
  flex-shrink: 0;
}
...
.k-rtl .k-ie .k-form-buttons .k-button ~ .k-button,
...
.k-slider .k-draghandle.k-focus {
  box-shadow: 0 0 0 3px rgba(116, 70, 98, 0.5);
}
...
.k-calendar .k-calendar-view .k-today .k-link {
  box-shadow: inset 0 0 0 1px #744662;
}
.k-calendar .k-calendar-view .k-today.k-focus .k-calendar-cell-inner,
...
.k-calendar .k-calendar-view .k-today.k-state-focused .k-link {
  box-shadow: inset 0 0 0 1px #744662, inset 0 0 0 0.25rem rgba(218, 210, 189, 0.5);
}
...
.k-calendar .k-calendar-td.k-state-focused .k-link {
  box-shadow: inset 0 0 0 0.25rem rgba(218, 210, 189, 0.5);
}
...
.k-calendar .k-calendar-td.k-state-selected.k-state-focus .k-link {
  box-shadow: inset 0 0 0 2px rgba(76, 46, 64, 0.5);
}
...
.k-calendar .k-range-split-start::after {
  left: -5px;
  right: auto;
  background-image: linear-gradient(to left, rgba(116, 70, 98, 0.25), transparent 100%);
}
.k-calendar .k-range-split-end::after {
  right: -5px;
  left: auto;
  background-image: linear-gradient(to right, rgba(116, 70, 98, 0.25), transparent 100%);
}
.k-timeselector {
  border-width: 1px;
  border-style: solid;
...
.k-treeview-leaf.k-focus {
  box-shadow: inset 0 0 0 2px rgba(73, 65, 56, 0.15);
}
...
.k-rating.k-state-focused .k-rating-item.k-selected > .k-icon,
.k-rating.k-focus .k-rating-item.k-state-selected > .k-icon,
...
.k-rating-item.k-state-selected.k-focus,
.k-rating-item.k-selected:focus,
.k-rating-item.k-selected.k-state-focused,
...
.k-switch-off.k-focus .k-switch-track {
  border-color: #baa3b1;
  outline: 0.25rem solid rgba(116, 70, 98, 0.25);
}
...
.k-upload .k-file-error .k-file-extension-wrapper::before {
  background-color: #ffffff;
  border-color: transparent transparent #6d6760 #6d6760;
}
.k-upload .k-multiple-files-extension-wrapper::after,
.k-upload .k-multiple-files-invalid-extension-wrapper::after {
  border-top-color: #6d6760;
  border-left-color: #6d6760;
}
...
.k-fab-solid-primary:focus {
  outline-style: solid;
  outline-width: 3px;
  outline-color: rgba(116, 70, 98, 0.5);
}
.k-fab-solid-secondary.k-focus,
.k-fab-solid-secondary:focus {
  outline-style: solid;
  outline-width: 3px;
  outline-color: rgba(232, 227, 214, 0.5);
}
...
.k-fab-item-icon {
  ...
  background-color: #dad2bd;
  box-shadow: 0px 6px 10px rgba(0, 0, 0, 0.14), 0px 1px 18px rgba(0, 0, 0, 0.12), 0px 3px 5px rgba(0, 0, 0, 0.2);
  outline: 1px solid #dad2bd;
  outline-offset: -1px;
}
.k-fab-item.k-hover .k-fab-item-icon,
.k-fab-item:hover .k-fab-item-icon {
  box-shadow: 0px 6px 10px rgba(0, 0, 0, 0.14), 0px 1px 18px rgba(0, 0, 0, 0.12), 0px 3px 5px rgba(0, 0, 0, 0.2);
  outline: 1px solid #c8bc9c;
  outline-offset: -1px;
  border-color: #c8bc9c;
  color: black;
  background-color: #ccc1a4;
...
.k-fab-item.k-focus .k-fab-item-icon {
  outline-style: solid;
  outline-width: 3px;
  outline-color: rgba(218, 210, 189, 0.5);
}
.k-fab-item.k-active .k-fab-item-icon,
.k-fab-item:active .k-fab-item-icon {
  outline: 1px solid #c3b694;
  outline-offset: -1px;
  border-color: #c3b694;
  color: black;
  background-color: #c8bc9c;
...
.k-bottom-nav-solid.k-bottom-nav-primary .k-bottom-nav-item:focus {
  background-color: rgba(206, 190, 200, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-secondary .k-bottom-nav-item:focus {
  background-color: rgba(81, 79, 75, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-info .k-bottom-nav-item:focus {
  background-color: rgba(205, 233, 243, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-success .k-bottom-nav-item:focus {
  background-color: rgba(215, 231, 193, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-warning .k-bottom-nav-item:focus {
  background-color: rgba(81, 67, 36, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-error .k-bottom-nav-item:focus {
  background-color: rgba(229, 180, 197, 0.2);
}
...
.k-bottom-nav-flat .k-bottom-nav-item:focus {
  background-color: rgba(73, 65, 56, 0.05);
}
...
.k-breadcrumb-link.k-focus {
  box-shadow: inset 0 0 0 3px rgba(73, 65, 56, 0.25);
}
.k-breadcrumb-root-link {
  color: #744662;
}
...
.k-pager-numbers .k-disabled.k-link,
...
.k-focus.k-pager-refresh {
  background-color: #ffffff;
  box-shadow: 0 0 0 3px rgba(116, 70, 98, 0.25);
}
.k-pager-numbers .k-link {
  border-color: #dee2e6;
  color: #744662;
...
.k-pager-md .k-pager-numbers .k-current-page .k-link.k-hover,
...
.k-pager-md .k-pager-numbers.k-state-expanded .k-link.k-hover,
...
.k-pager-md .k-pager-numbers.k-state-expanded .k-link.k-selected,
...
.k-grid-header .k-grid-header-sticky.k-sorted {
  color: #494138;
  background-color: #f2efe8;
  border-right-color: rgba(73, 65, 56, 0.5);
  border-left-color: rgba(73, 65, 56, 0.5);
}
...
.k-master-row .k-grid-row-sticky {
  border-top-color: rgba(73, 65, 56, 0.5);
  border-bottom-color: rgba(73, 65, 56, 0.5);
  background-color: #ffffff;
}
...
kendo-grid .k-grid-content-sticky.k-hover {
  background-color: #ebebeb;
}
kendo-grid .k-grid-row-sticky td {
  border-top-color: rgba(73, 65, 56, 0.5);
...
.k-spreadsheet-active-cell.k-right {
  box-shadow: inset 0 0 0 1px #744662, inset -1px 0 0 1px #744662;
}
.k-spreadsheet-active-cell.k-bottom {
  box-shadow: inset 0 0 0 1px #744662, inset 0 -1px 0 1px #744662;
}
.k-spreadsheet-active-cell.k-bottom.k-right {
  box-shadow: inset 0 0 0 1px #744662, inset -1px -1px 0 1px #744662;
}
.k-spreadsheet .k-auto-fill {
  border-color: #744662;
  background-color: rgba(116, 70, 98, 0.25);
...
.k-spreadsheet-has-comment::after {
  border-color: #744662 #744662 transparent transparent;
}
.k-dirty {
  border-color: #b42a58 transparent transparent #b42a58;
}
.k-spreadsheet .k-filter-range {
  border-color: #744662;
}
.k-spreadsheet-filter {
  ...
  color: #212529;
  background-color: #dad2bd;
  box-shadow: inset 0 0 0 1px #dad2bd;
}
...
.k-spreadsheet-drawing-anchor-cell {
  background: rgba(116, 70, 98, 0.25);
}
...
[dir="rtl"] .k-spreadsheet .k-spreadsheet-has-comment::after {
  border-color: #744662 transparent transparent #744662;
}
.k-rtl .k-spreadsheet .k-dirty,
.k-spreadsheet[dir="rtl"] .k-dirty,
...
.k-editor-table-wizard-dialog .k-numerictextbox + .k-color-picker,
...
.k-editor-table-wizard-dialog .k-color-picker,
...
.k-task-milestone.k-task-delayed {
  background-image: repeating-linear-gradient(90deg, #ffffff, #ffffff 2px, #b42a58 2px, #b42a58 4px);
}
...
.k-task-offset {
  background-image: repeating-linear-gradient(135deg, #ffffff, #ffffff 2px, #b42a58 2px, #b42a58 4px);
}
...
.k-task-offset:hover {
  background-image: repeating-linear-gradient(135deg, #ffffff, #ffffff 2px, #d27f9b 2px, #d27f9b 4px);
}
...
.k-mediaplayer-titlebar {
  color: #ffffff;
  background-image: linear-gradient(rgba(73, 65, 56, 0.7), rgba(73, 65, 56, 0));
  text-shadow: 0 0 2px rgba(73, 65, 56, 0.5);
}
.k-timeline {
  box-sizing: border-box;
  outline: 0;
...
.k-var--series-9 {
  background-color: #6fd0e7;
}
.k-var--series-10 {
  background-color: #47a7b5;
}
.k-var--series-11 {
  background-color: #e7cc79;
}
.k-var--series-12 {
  background-color: #c6a340;
}
.k-var--series-13 {
  background-color: #955f80;
}
.k-var--series-14 {
  background-color: #571d43;
}
.k-var--series-15 {
  background-color: #2f90a7;
}
.k-var--series-16 {
...
.k-var--series-25 {
  background-color: #633f56;
}
.k-var--series-26 {
  background-color: #3a132d;
}
.k-var--series-27 {
...
.k-var--chart-inactive {
  background-color: rgba(73, 65, 56, 0.5);
}
...
.k-signature .k-signature-line {
  border-bottom-color: rgba(112, 193, 222, 0.24);
}
