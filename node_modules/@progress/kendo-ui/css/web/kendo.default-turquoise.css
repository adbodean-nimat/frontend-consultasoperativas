...
.k-checkbox.k-indeterminate {
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%2328bfba' stroke-linecap='square' stroke-linejoin='square' stroke-width='2' d='M4,8 h8'/%3e%3c/svg%3e");
}
.k-checkbox:disabled,
...
.k-checkbox.k-checked.k-focus {
  box-shadow: 0 0 0 2px rgba(40, 191, 186, 0.3);
}
...
.k-button-solid-primary.k-focus {
  box-shadow: 0 0 0px 2px rgba(40, 191, 186, 0.3);
}
.k-button-solid-primary:active,
.k-button-solid-primary.k-active {
  border-color: #23a8a4;
  background-color: #23a8a4;
}
...
.k-table-list .k-table-row.k-selected {
  background-color: rgba(40, 191, 186, 0.25);
}
.k-virtual-scroller {
  width: 100%;
  height: 100%;
...
.k-calendar .k-range-split-start::after {
  left: -5px;
  right: auto;
  background-image: linear-gradient(to left, rgba(40, 191, 186, 0.25), transparent 100%);
}
.k-calendar .k-range-split-end::after {
  right: -5px;
  left: auto;
  background-image: linear-gradient(to right, rgba(40, 191, 186, 0.25), transparent 100%);
}
.k-timeselector {
  border-width: 1px;
  border-style: solid;
...
.k-switch-on.k-focus .k-switch-track {
  outline: 2px solid rgba(40, 191, 186, 0.25);
}
...
.k-fab-solid-primary:focus {
  outline-style: solid;
  outline-width: 2px;
  outline-color: rgba(40, 191, 186, 0.3);
}
...
.k-bottom-nav-solid.k-bottom-nav-primary .k-bottom-nav-item:focus {
  background-color: rgba(180, 233, 231, 0.2);
}
...
.k-pager-numbers .k-link.k-hover {
  color: #28bfba;
  background-color: rgba(40, 191, 186, 0.08);
}
.k-pager-numbers .k-link:focus,
.k-pager-numbers .k-link.k-state-focus,
.k-pager-numbers .k-link.k-focus {
  background-color: transparent;
  box-shadow: inset 0 0 0 2px rgba(40, 191, 186, 0.12);
}
.k-pager-numbers .k-link.k-state-selected,
.k-pager-numbers .k-link.k-selected {
  color: #28bfba;
  background-color: rgba(40, 191, 186, 0.2);
}
...
.k-spreadsheet-selection {
  border-color: #28bfba;
  background-color: rgba(40, 191, 186, 0.25);
  box-shadow: inset 0 0 0 1px #28bfba;
}
.k-spreadsheet .k-single-selection::after {
  border-color: #ffffff;
  background-color: #28bfba;
...
.k-spreadsheet-active-cell.k-right {
  box-shadow: inset 0 0 0 1px #28bfba, inset -1px 0 0 1px #28bfba;
}
.k-spreadsheet-active-cell.k-bottom {
  box-shadow: inset 0 0 0 1px #28bfba, inset 0 -1px 0 1px #28bfba;
}
.k-spreadsheet-active-cell.k-bottom.k-right {
  box-shadow: inset 0 0 0 1px #28bfba, inset -1px -1px 0 1px #28bfba;
}
.k-spreadsheet .k-auto-fill {
  border-color: #28bfba;
  background-color: rgba(40, 191, 186, 0.25);
...
.k-spreadsheet-has-comment::after {
  border-color: #28bfba #28bfba transparent transparent;
}
.k-dirty {
...
.k-spreadsheet-drawing-anchor-cell {
  background: rgba(40, 191, 186, 0.25);
}
.k-rtl .k-spreadsheet .k-spreadsheet-has-comment::after,
.k-spreadsheet[dir="rtl"] .k-spreadsheet-has-comment::after,
[dir="rtl"] .k-spreadsheet .k-spreadsheet-has-comment::after {
  border-color: #28bfba transparent transparent #28bfba;
}
.k-rtl .k-spreadsheet .k-dirty,
.k-spreadsheet[dir="rtl"] .k-dirty,
...
.k-chat .k-alt .k-bubble {
  ...
  color: white;
  background-color: #28bfba;
  box-shadow: 0 1px 2px rgba(40, 191, 186, 0.2);
}
...
.k-chat .k-alt .k-selected .k-bubble {
  box-shadow: 0 3px 10px rgba(40, 191, 186, 0.4);
}
...
.k-timeline-track-item.k-focus .k-timeline-circle {
  box-shadow: 0 3px 4px 0 rgba(40, 191, 186, 0.4);
}
.k-pdf-viewer {
  border-width: 1px;
  border-style: solid;
