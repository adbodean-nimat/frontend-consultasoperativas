...
.k-dirty {
  ...
  border-width: 3px;
  border-style: solid;
  border-color: #e3470e #e3470e transparent transparent;
  position: absolute;
  top: 0;
  right: 0;
}
[dir="rtl"] .k-dirty,
.k-rtl .k-dirty {
  border-color: transparent transparent #e3470e #e3470e;
  right: auto;
  left: 0;
}
.k-placeholder-line {
...
.k-bg-error {
  background-color: #e3470e !important;
}
.k-bg-dark {
...
.k-checkbox.k-focus {
  border-color: #ffae8d;
  box-shadow: 0 0 0 0.25rem rgba(255, 92, 26, 0.25);
}
.k-checkbox:indeterminate,
.k-checkbox.k-indeterminate {
  border-color: #ff5c1a;
...
.k-button-solid-base.k-focus {
  box-shadow: 0 0 0 0.25rem rgba(87, 152, 190, 0.5);
}
...
.k-button-solid-primary.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(255, 92, 26, 0.5);
}
...
.k-button-solid-secondary.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(115, 169, 201, 0.5);
}
.k-button-solid-secondary:active,
.k-button-solid-secondary.k-active {
  border-color: #468cb6;
  background-color: #4e92bb;
}
...
.k-button-solid-info.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(91, 192, 222, 0.5);
}
...
.k-button-solid-success.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(92, 184, 92, 0.5);
}
...
.k-button-solid-warning.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(255, 187, 91, 0.5);
}
...
.k-button-solid-error.k-hover {
  border-color: #b3380b;
  background-color: #bf3c0c;
}
.k-button-solid-error:focus,
.k-button-solid-error.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(227, 71, 14, 0.5);
}
...
.k-button-outline-base.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(28, 58, 76, 0.5);
}
...
.k-input-solid.ng-invalid.ng-dirty.k-focus {
  box-shadow: 0 0 0 0.25rem rgba(227, 71, 14, 0.25);
}
...
.k-input-outline {
  border-color: rgba(28, 58, 76, 0.5);
  color: #1c3a4c;
}
...
.k-table-list .k-table-row.k-selected {
  border-color: #dee2e6;
  color: #212529;
  background-color: rgba(255, 92, 26, 0.25);
}
.k-virtual-scroller {
  width: 100%;
  height: 100%;
...
.k-chip-solid-base.k-focus {
  box-shadow: 0 0 0 2px rgba(28, 58, 76, 0.16);
  background-color: #edeff1;
}
...
.k-chip-solid-error.k-focus {
  box-shadow: 0 0 0 2px rgba(227, 71, 14, 0.16);
  background-color: #fdf0ec;
}
...
.k-chip-solid-warning.k-focus {
  box-shadow: 0 0 0 2px rgba(255, 187, 91, 0.16);
  background-color: #fffaf2;
}
...
.k-no-color .k-color-preview-mask::before {
  content: "";
  background-color: #ffffff;
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='20' height='20' version='1.1'%3e%3cline x1='0' x2='20' y1='0' y2='20' stroke='%23e3470e' stroke-width='1'/%3e%3c/svg%3e");
...
.k-slider .k-draghandle.k-focus {
  box-shadow: 0 0 0 3px rgba(255, 92, 26, 0.5);
}
...
.k-calendar .k-calendar-view .k-today .k-link {
  box-shadow: inset 0 0 0 1px #ff5c1a;
}
...
.k-calendar .k-calendar-view .k-today.k-state-focused .k-link {
  box-shadow: inset 0 0 0 1px #ff5c1a, inset 0 0 0 0.25rem rgba(87, 152, 190, 0.5);
}
...
.k-calendar .k-calendar-td.k-state-focused .k-link {
  box-shadow: inset 0 0 0 0.25rem rgba(87, 152, 190, 0.5);
}
...
.k-calendar .k-calendar-td.k-state-selected.k-state-focus .k-link {
  box-shadow: inset 0 0 0 2px rgba(217, 63, 0, 0.5);
}
...
.k-calendar .k-range-split-start::after {
  left: -5px;
  right: auto;
  background-image: linear-gradient(to left, rgba(255, 92, 26, 0.25), transparent 100%);
}
.k-calendar .k-range-split-end::after {
  right: -5px;
  left: auto;
  background-image: linear-gradient(to right, rgba(255, 92, 26, 0.25), transparent 100%);
}
.k-timeselector {
  border-width: 1px;
  border-style: solid;
...
.k-switch-off.k-focus .k-switch-track {
  border-color: #ffae8d;
  outline: 0.25rem solid rgba(255, 92, 26, 0.25);
}
...
.k-fab-solid-primary:focus {
  outline-style: solid;
  outline-width: 3px;
  outline-color: rgba(255, 92, 26, 0.5);
}
.k-fab-solid-secondary.k-focus,
.k-fab-solid-secondary:focus {
  outline-style: solid;
  outline-width: 3px;
  outline-color: rgba(115, 169, 201, 0.5);
}
...
.k-fab-item-icon {
  ...
  background-color: #5798be;
  box-shadow: 0px 6px 10px rgba(0, 0, 0, 0.14), 0px 1px 18px rgba(0, 0, 0, 0.12), 0px 3px 5px rgba(0, 0, 0, 0.2);
  outline: 1px solid #5798be;
  outline-offset: -1px;
}
.k-fab-item.k-hover .k-fab-item-icon,
.k-fab-item:hover .k-fab-item-icon {
  box-shadow: 0px 6px 10px rgba(0, 0, 0, 0.14), 0px 1px 18px rgba(0, 0, 0, 0.12), 0px 3px 5px rgba(0, 0, 0, 0.2);
  outline: 1px solid #3f7ea3;
  outline-offset: -1px;
  border-color: #3f7ea3;
  color: white;
  background-color: #4385ac;
...
.k-fab-item.k-focus .k-fab-item-icon {
  outline-style: solid;
  outline-width: 3px;
  outline-color: rgba(87, 152, 190, 0.5);
}
.k-fab-item.k-active .k-fab-item-icon,
.k-fab-item:active .k-fab-item-icon {
  outline: 1px solid #3b779a;
  outline-offset: -1px;
  border-color: #3b779a;
  color: white;
  background-color: #3f7ea3;
...
.k-bottom-nav-solid.k-bottom-nav-primary .k-bottom-nav-item:focus {
  background-color: rgba(255, 198, 175, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-secondary .k-bottom-nav-item:focus {
  background-color: rgba(206, 225, 236, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-info .k-bottom-nav-item:focus {
  background-color: rgba(198, 233, 243, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-warning .k-bottom-nav-item:focus {
  background-color: rgba(89, 65, 32, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-error .k-bottom-nav-item:focus {
  background-color: rgba(245, 191, 171, 0.2);
}
...
.k-spreadsheet-active-cell.k-right {
  box-shadow: inset 0 0 0 1px #ff5c1a, inset -1px 0 0 1px #ff5c1a;
}
.k-spreadsheet-active-cell.k-bottom {
  box-shadow: inset 0 0 0 1px #ff5c1a, inset 0 -1px 0 1px #ff5c1a;
}
.k-spreadsheet-active-cell.k-bottom.k-right {
  box-shadow: inset 0 0 0 1px #ff5c1a, inset -1px -1px 0 1px #ff5c1a;
}
.k-spreadsheet .k-auto-fill {
  border-color: #ff5c1a;
  background-color: rgba(255, 92, 26, 0.25);
...
.k-spreadsheet-has-comment::after {
  border-color: #ff5c1a #ff5c1a transparent transparent;
}
.k-dirty {
  border-color: #e3470e transparent transparent #e3470e;
}
.k-spreadsheet .k-filter-range {
  border-color: #ff5c1a;
}
.k-spreadsheet-filter {
  ...
  color: #ffffff;
  background-color: #5798be;
  box-shadow: inset 0 0 0 1px #5798be;
}
...
[dir="rtl"] .k-spreadsheet .k-spreadsheet-has-comment::after {
  border-color: #ff5c1a transparent transparent #ff5c1a;
}
.k-rtl .k-spreadsheet .k-dirty,
.k-spreadsheet[dir="rtl"] .k-dirty,
...
.k-task-milestone.k-task-delayed {
  background-image: repeating-linear-gradient(90deg, #ffffff, #ffffff 2px, #e3470e 2px, #e3470e 4px);
}
...
.k-task-offset {
  background-image: repeating-linear-gradient(135deg, #ffffff, #ffffff 2px, #e3470e 2px, #e3470e 4px);
}
...
.k-task-offset:hover {
  background-image: repeating-linear-gradient(135deg, #ffffff, #ffffff 2px, #ee916e 2px, #ee916e 4px);
}
...
.k-signature .k-signature-line {
  border-bottom-color: rgba(91, 192, 222, 0.24);
}
