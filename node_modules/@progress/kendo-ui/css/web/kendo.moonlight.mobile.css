...
.km-widget.km-buttongroup > *.km-active {
  border-right-width: 1px;
}
.km-widget.km-buttongroup > *.km-state-active,
.km-widget.km-buttongroup > *.km-active + * {
...
li.km-active .km-listview-link,
li.km-state-active .km-listview-label,
li.km-active .km-listview-label,
.km-state-active .km-listview-link:after,
.km-active .km-listview-link:after {
  color: #171e28;
}
.km-loader > *:not(h1),
.km-filter-wrap > input,
