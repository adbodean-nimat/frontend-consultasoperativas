...
.k-button-outline-base.k-focus {
  box-shadow: 0 0 0px 0.25rem rgba(255, 255, 255, 0.5);
}
...
.k-calendar-infinite .k-calendar-view::after {
  ...
  width: 150%;
  left: -25%;
  box-shadow: 0 0 38px 19px #000000;
}
...
.k-calendar .k-calendar-view .k-today.k-state-focused .k-link {
  box-shadow: inset 0 0 0 1px #0d6efd, inset 0 0 0 0.25rem rgba(52, 58, 64, 0.5);
}
...
.k-calendar .k-calendar-td.k-state-focused .k-link {
  box-shadow: inset 0 0 0 0.25rem rgba(52, 58, 64, 0.5);
}
...
.k-calendar .k-calendar-td.k-state-selected.k-state-focus .k-link {
  box-shadow: inset 0 0 0 2px rgba(76, 148, 254, 0.5);
}
.k-calendar .k-calendar-navigation {
  color: #ffffff;
  background-color: #212529;
  box-shadow: inset -1px 0 #495057;
}
...
.k-time-list::before,
.k-time-list::after {
  box-shadow: 0 0 3em 1.5em #000000;
}
...
.k-fab-solid-primary:disabled {
  box-shadow: 0px 6px 10px rgba(0, 0, 0, 0.1744), 0px 1px 18px rgba(0, 0, 0, 0.1552), 0px 3px 5px rgba(0, 0, 0, 0.232);
...
.k-card.k-state-focus .k-card-callout.k-callout-s {
  box-shadow: 3px -3px 0 0 rgba(73, 80, 87, 0.5);
}
...
.k-task-milestone.k-task-delayed {
  background-image: repeating-linear-gradient(90deg, #000000, #000000 2px, #dc3545 2px, #dc3545 4px);
}
...
.k-task-offset {
  background-image: repeating-linear-gradient(135deg, #000000, #000000 2px, #dc3545 2px, #dc3545 4px);
}
...
.k-task-offset:hover {
  background-image: repeating-linear-gradient(135deg, #000000, #000000 2px, #ea868f 2px, #ea868f 4px);
}
...
.k-selection {
  border-color: rgba(255, 255, 255, 0.08);
  box-shadow: inset 0 1px 7px rgba(255, 255, 255, 0.15);
}
.k-selection-bg {
  background-color: transparent;
}
...
.k-treemap .k-leaf.k-hover {
  box-shadow: inset 0 0 0 3px #495057;
}
.k-map {
  height: 600px;
  box-sizing: border-box;
