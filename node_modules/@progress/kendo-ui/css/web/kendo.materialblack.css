...
.k-button-solid-tertiary.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(50, 65, 145, 0.75);
}
...
.k-button-solid-info.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(26, 120, 194, 0.75);
}
...
.k-button-solid-success.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(61, 140, 64, 0.75);
}
...
.k-button-outline-base.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(213, 213, 213, 0.75);
}
...
.k-button-outline-primary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(63, 81, 181, 0.75);
}
...
.k-button-outline-info.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(33, 150, 243, 0.75);
}
...
.k-button-outline-success.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(76, 175, 80, 0.75);
}
...
.k-fab-solid-primary:active {
  border-color: #32408f;
  background-color: #32408f;
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(63, 81, 181, 0.4);
}
...
.k-fab-solid-info:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(33, 150, 243, 0.4);
}
...
.k-fab-solid-success:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(76, 175, 80, 0.4);
}
...
.k-fab-item:active .k-fab-item-icon {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(92, 92, 92, 0.4);
}
...
.k-chip-solid-base.k-focus {
  box-shadow: 0 0 0 2px rgba(213, 213, 213, 0.16);
  background-color: rgba(213, 213, 213, 0.08);
}
...
.k-chip-outline-base.k-focus {
  box-shadow: 0 0 0 2px rgba(213, 213, 213, 0.08);
}
...
.k-gantt .k-treelist tr.k-selected,
.k-gantt .k-treelist tr.k-state-selected td,
.k-gantt .k-treelist tr.k-selected td,
.k-gantt .k-treelist tr.k-alt.k-state-selected,
.k-gantt .k-treelist tr.k-alt.k-selected,
.k-gantt .k-treelist tr.k-alt.k-state-selected > td,
.k-gantt .k-treelist tr.k-alt.k-selected > td {
  background-color: #363636;
}
...
.k-grid td.k-focus.k-state-selected,
.k-grid td.k-state-focused.k-selected,
...
.k-grid .k-grouping-header .k-link,
.k-grid .k-grouping-header .k-link:link,
...
.k-treelist tr.k-selected,
.k-treelist tr.k-state-selected td,
.k-treelist tr.k-selected td,
.k-treelist tr.k-alt.k-state-selected,
.k-treelist tr.k-alt.k-selected,
.k-treelist tr.k-alt.k-state-selected > td,
.k-treelist tr.k-alt.k-selected > td {
  background-color: #00b0ff;
  border-color: #00b0ff;
}
