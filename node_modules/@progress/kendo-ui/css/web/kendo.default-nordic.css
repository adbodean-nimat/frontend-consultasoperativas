...
.k-checkbox.k-indeterminate {
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%23e7607b' stroke-linecap='square' stroke-linejoin='square' stroke-width='2' d='M4,8 h8'/%3e%3c/svg%3e");
}
.k-checkbox:disabled,
...
.k-checkbox.k-checked.k-focus {
  box-shadow: 0 0 0 2px rgba(231, 96, 123, 0.3);
}
...
.k-button-solid-primary.k-focus {
  box-shadow: 0 0 0px 2px rgba(231, 96, 123, 0.3);
}
...
.k-button-solid-secondary.k-focus {
  box-shadow: 0 0 0px 2px rgba(214, 229, 233, 0.3);
}
...
.k-button-solid-info.k-focus {
  box-shadow: 0 0 0px 2px rgba(1, 168, 193, 0.3);
}
...
.k-button-solid-success.k-focus {
  box-shadow: 0 0 0px 2px rgba(144, 191, 79, 0.3);
}
.k-button-solid-success:active,
.k-button-solid-success.k-active {
  border-color: #7fa846;
  background-color: #7fa846;
}
...
.k-button-solid-warning.k-focus {
  box-shadow: 0 0 0px 2px rgba(255, 200, 87, 0.3);
}
...
.k-button-solid-error.k-hover {
  border-color: #cb0f36;
  background-color: #cb0f36;
}
.k-button-solid-error:focus,
.k-button-solid-error.k-focus {
  box-shadow: 0 0 0px 2px rgba(211, 16, 56, 0.3);
}
...
.k-button-outline-base.k-focus {
  box-shadow: 0 0 0px 2px rgba(41, 43, 44, 0.3);
}
...
.k-loader-spinner-3.k-loader-md .k-loader-canvas {
  margin: 4px;
  width: 24px;
  height: 19.71281292px;
}
.k-loader-spinner-3.k-loader-lg .k-loader-canvas {
  margin: 8px;
  width: 48px;
  height: 39.42562584px;
}
...
.k-switch-on.k-focus .k-switch-track {
  outline: 2px solid rgba(231, 96, 123, 0.25);
}
...
.k-fab-solid-primary:focus {
  outline-style: solid;
  outline-width: 2px;
  outline-color: rgba(231, 96, 123, 0.3);
}
.k-fab-solid-secondary.k-focus,
.k-fab-solid-secondary:focus {
  outline-style: solid;
  outline-width: 2px;
  outline-color: rgba(214, 229, 233, 0.3);
}
...
.k-pager-numbers .k-link.k-hover {
  color: #e7607b;
  background-color: rgba(231, 96, 123, 0.08);
}
.k-pager-numbers .k-link:focus,
.k-pager-numbers .k-link.k-state-focus,
.k-pager-numbers .k-link.k-focus {
  background-color: transparent;
  box-shadow: inset 0 0 0 2px rgba(231, 96, 123, 0.12);
}
.k-pager-numbers .k-link.k-state-selected,
.k-pager-numbers .k-link.k-selected {
  color: #e7607b;
  background-color: rgba(231, 96, 123, 0.2);
}
...
.k-filterable > .k-cell-inner {
  -webkit-margin-end: calc(-1.42857143em - 14px);
  margin-inline-end: calc(-1.42857143em - 14px);
}
...
.k-d-flex-row .k-pivotgrid-configurator-overlay {
  right: calc(1.42857143em + 10px);
}
.k-flex-row-reverse .k-pivotgrid-configurator-overlay {
  left: calc(1.42857143em + 10px);
}
...
.k-chat .k-alt .k-bubble {
  ...
  color: white;
  background-color: #e7607b;
  box-shadow: 0 1px 2px rgba(231, 96, 123, 0.2);
}
...
.k-chat .k-alt .k-selected .k-bubble {
  box-shadow: 0 3px 10px rgba(231, 96, 123, 0.4);
}
...
.k-timeline-track-item.k-focus .k-timeline-circle {
  box-shadow: 0 3px 4px 0 rgba(231, 96, 123, 0.4);
}
.k-pdf-viewer {
  border-width: 1px;
  border-style: solid;
