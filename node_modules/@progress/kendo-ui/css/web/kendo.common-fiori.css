...
.k-input-button.k-button {
  width: calc(1.7142857143em + 16px);
  height: calc(1.7142857143em + 16px);
  border-width: 0;
...
.k-grid .k-header > .k-cell-inner {
  margin: -0.929em -0.6em -0.714em -0.6em;
}
...
.k-time-list-wrapper {
  ...
  text-align: center;
  width: 5em;
  height: calc(11.99999997em + 56px);
}
...
.k-floating-label-container.k-focus > .k-label {
  -webkit-transform: translate(-14px, -8px) translate(-1px, -1.2857142825em) translate(-12.5%, -12.5%) scale(0.75);
      -ms-transform: translate(-14px, -8px) translate(-1px, -1.2857142825em) translate(-12.5%, -12.5%) scale(0.75);
          transform: translate(-14px, -8px) translate(-1px, -1.2857142825em) translate(-12.5%, -12.5%) scale(0.75);
}
...
.k-floating-label-container[dir='rtl'].k-focus > .k-label {
  -webkit-transform: translate(14px, -6px) translate(1px, -1.2857142825) translate(12.5%, -9.375%) scale(0.75);
      -ms-transform: translate(14px, -6px) translate(1px, -1.2857142825) translate(12.5%, -9.375%) scale(0.75);
          transform: translate(14px, -6px) translate(1px, -1.2857142825) translate(12.5%, -9.375%) scale(0.75);
}
.k-input-label {
  margin-right: 14px;
  z-index: 1;
...
.k-spreadsheet > .k-spreadsheet-view .k-disabled {
  pointer-events: auto;
}
...
.k-spreadsheet-window .k-edit-field .k-dropdownlist {
  width: 100%;
}
...
.k-taskboard-column-new {
  max-height: calc(3.06428571em + 16px);
}
...
.k-flex-row .k-pivotgrid-configurator-overlay {
  right: calc(1.7142857143em + 16px);
}
.k-flex-row-reverse .k-pivotgrid-configurator-overlay {
  left: calc(1.7142857143em + 16px);
}
.k-flex-col .k-pivotgrid-configurator-overlay {
  bottom: calc(1.7142857143em + 16px);
}
.k-flex-col-reverse .k-pivotgrid-configurator-overlay {
  top: calc(1.7142857143em + 16px);
}
...
.k-colorpicker .k-selected-color .k-i-line {
  line-height: calc(1.7142857143em + 16px);
  font-size: calc(1.7142857143em + 16px);
}
.k-grouping-header {
  padding: 0.429em;
}
