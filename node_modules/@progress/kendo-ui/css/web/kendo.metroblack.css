...
.k-button-solid-secondary.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(11, 11, 11, 0.75);
}
...
.k-button-solid-tertiary.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(0, 137, 135, 0.75);
}
...
.k-button-solid-warning.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(204, 142, 44, 0.75);
}
...
.k-button-solid-error.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(181, 0, 0, 0.75);
}
...
.k-button-outline-primary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(0, 136, 134, 0.75);
}
...
.k-button-outline-secondary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(14, 14, 14, 0.75);
}
...
.k-button-outline-tertiary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(0, 171, 169, 0.75);
}
...
.k-button-outline-warning.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(255, 177, 55, 0.75);
}
...
.k-button-outline-error.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(226, 0, 0, 0.75);
}
...
.k-fab-solid-primary:active {
  border-color: #005554;
  background-color: #005554;
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(0, 136, 134, 0.4);
}
...
.k-fab-solid-secondary:active {
  border-color: #000000;
  background-color: #000000;
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(14, 14, 14, 0.4);
}
...
.k-fab-solid-tertiary:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(0, 171, 169, 0.4);
}
...
.k-fab-solid-warning:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(255, 177, 55, 0.4);
}
...
.k-fab-solid-error:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(226, 0, 0, 0.4);
}
...
.k-fab-item:active .k-fab-item-icon {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(52, 52, 52, 0.4);
}
...
.k-bottom-nav-solid.k-bottom-nav-primary .k-bottom-nav-item:focus {
  background-color: rgba(166, 213, 213, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-tertiary .k-bottom-nav-item:focus {
  background-color: rgba(166, 226, 225, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-warning .k-bottom-nav-item:focus {
  background-color: rgba(89, 62, 19, 0.2);
}
...
.k-pivotgrid-row.k-selected > .k-pivotgrid-cell {
  background-color: rgba(0, 136, 134, 0.25);
}
...
.k-chip-solid-warning {
  border-color: rgba(255, 177, 55, 0.3);
  color: #ffb137;
  background-color: rgba(255, 177, 55, 0.08);
}
.k-chip-solid-warning:hover,
.k-chip-solid-warning.k-hover {
  background-color: rgba(255, 177, 55, 0.16);
}
.k-chip-solid-warning:focus,
.k-chip-solid-warning.k-focus {
  box-shadow: 0 0 0 2px rgba(255, 177, 55, 0.16);
}
.k-chip-solid-warning.k-selected {
  background-color: rgba(255, 177, 55, 0.24);
}
.k-chip-solid-error {
...
.k-chip-solid-error.k-hover {
  background-color: rgba(226, 0, 0, 0.16);
}
.k-chip-solid-error:focus,
.k-chip-solid-error.k-focus {
  box-shadow: 0 0 0 2px rgba(226, 0, 0, 0.16);
}
.k-chip-solid-error.k-selected {
  background-color: rgba(226, 0, 0, 0.24);
}
.k-chip-solid-info {
...
.k-panelbar > li > .k-link.k-hover,
.k-panelbar > li.k-state-hover > .k-link,
.k-panelbar > li.k-hover > .k-link,
.k-panelbar > li.k-state-default > .k-link.k-state-hover,
.k-panelbar > li.k-state-default > .k-link.k-hover {
  color: #fff;
}
.k-panelbar .k-state-focused.k-state-hover,
.k-panelbar .k-state-focused.k-hover,
.k-panelbar .k-focus.k-state-hover,
...
.k-grid tr .k-focus.k-state-selected,
.k-grid tr .k-state-focused.k-selected,
.k-grid tr .k-focus.k-selected,
.k-grid tr.k-state-selected td.k-state-focused,
.k-grid tr.k-state-selected td.k-focus,
.k-grid tr.k-selected td.k-state-focused,
.k-grid tr.k-selected td.k-focus,
