...
.k-button-solid-base.k-focus {
  border-color: #1984c8;
  box-shadow: 0 0 4px 0px rgba(25, 132, 200, 0.75);
}
...
.k-button-solid-secondary.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(194, 194, 195, 0.75);
}
...
.k-button-solid-tertiary.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(0, 98, 156, 0.75);
}
...
.k-button-solid-info.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(29, 122, 150, 0.75);
}
...
.k-button-solid-success.k-hover {
  border-color: #2b7337;
  background-color: #389446;
}
.k-button-solid-success:focus,
.k-button-solid-success.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(50, 131, 62, 0.75);
}
...
.k-button-solid-warning.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(204, 122, 0, 0.75);
}
...
.k-button-solid-error.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(174, 32, 0, 0.75);
}
...
.k-button-outline-base.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(81, 89, 103, 0.75);
}
...
.k-button-outline-primary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(25, 132, 200, 0.75);
}
...
.k-button-outline-secondary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(243, 243, 244, 0.75);
}
...
.k-button-outline-tertiary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(0, 123, 195, 0.75);
}
...
.k-button-outline-info.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(36, 152, 188, 0.75);
}
...
.k-button-outline-success.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(62, 164, 78, 0.75);
}
...
.k-button-outline-warning.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(255, 152, 0, 0.75);
}
...
.k-button-outline-error.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(217, 40, 0, 0.75);
}
...
.k-calendar td.k-focus .k-link {
  box-shadow: inset 0 0 4px 0px rgba(25, 132, 200, 0.75);
}
...
.k-fab-solid-primary:active {
  border-color: #13669b;
  background-color: #13669b;
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(25, 132, 200, 0.4);
}
...
.k-fab-solid-secondary:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(243, 243, 244, 0.4);
}
...
.k-fab-solid-tertiary:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(0, 123, 195, 0.4);
}
...
.k-fab-solid-info:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(36, 152, 188, 0.4);
}
...
.k-fab-solid-success:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(62, 164, 78, 0.4);
}
...
.k-fab-solid-warning:active {
  border-color: #cc7a00;
  background-color: #cc7a00;
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(255, 152, 0, 0.4);
}
...
.k-fab-solid-error:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(217, 40, 0, 0.4);
}
...
.k-bottom-nav-solid.k-bottom-nav-primary .k-bottom-nav-item:focus {
  background-color: rgba(175, 212, 236, 0.2);
}
...
.k-bottom-nav-flat .k-bottom-nav-item.k-selected:focus {
  background-color: rgba(81, 89, 103, 0.05);
}
...
.k-pivotgrid-row-headers .k-pivotgrid-row .k-pivotgrid-cell:last-child {
  border-right-color: #b1b1b4;
}
.k-pivotgrid-column-headers .k-pivotgrid-column-total:nth-last-of-type(2) .k-pivotgrid-cell:not(.k-pivotgrid-expanded),
.k-pivotgrid-column-headers .k-pivotgrid-row:last-child {
  border-bottom-color: #b1b1b4;
}
...
.k-pivotgrid-row.k-selected > .k-pivotgrid-cell {
  background-color: rgba(25, 132, 200, 0.25);
}
...
.k-chip-solid-base {
  border-color: rgba(81, 89, 103, 0.3);
  color: #515967;
  background-color: rgba(81, 89, 103, 0.08);
}
.k-chip-solid-base:hover,
.k-chip-solid-base.k-hover {
  background-color: rgba(81, 89, 103, 0.16);
}
.k-chip-solid-base:focus,
.k-chip-solid-base.k-focus {
  box-shadow: 0 0 0 2px rgba(81, 89, 103, 0.16);
  background-color: rgba(81, 89, 103, 0.08);
}
.k-chip-solid-base.k-selected {
  background-color: rgba(81, 89, 103, 0.24);
}
.k-chip-solid-success {
  border-color: rgba(62, 164, 78, 0.3);
  color: #3ea44e;
...
.k-chip-solid-error {
  border-color: rgba(217, 40, 0, 0.3);
  color: #d92800;
...
.k-chip-solid-info {
  border-color: rgba(36, 152, 188, 0.3);
  color: #2498bc;
...
.k-chip-outline-base.k-focus {
  box-shadow: 0 0 0 2px rgba(81, 89, 103, 0.08);
}
...
.k-no-color .k-color-preview-mask::before {
  content: "";
  background-image: url('data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2220%22%20height%3D%2220%22%20version%3D%221.1%22%3E%3Cline%20x1%3D%220%22%20x2%3D%2220%22%20y1%3D%220%22%20y2%3D%2220%22%20stroke%3D%22%23d92800%22%20stroke-width%3D%221%22/%3E%3C/svg%3E');
  background-color: white;
