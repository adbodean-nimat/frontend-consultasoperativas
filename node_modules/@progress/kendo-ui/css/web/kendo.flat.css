...
.k-button-solid-secondary.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(43, 46, 51, 0.75);
}
...
.k-button-solid-tertiary.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(13, 157, 142, 0.75);
}
...
.k-button-solid-info.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(0, 122, 163, 0.75);
}
...
.k-button-solid-success.k-hover {
  border-color: #1f7d30;
  background-color: #29a03e;
}
.k-button-solid-success:focus,
.k-button-solid-success.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(36, 142, 55, 0.75);
}
...
.k-button-solid-warning.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(203, 162, 50, 0.75);
}
.k-button-solid-warning:active,
.k-button-solid-warning.k-active,
.k-button-solid-warning.k-selected {
  border-color: #987926;
  background-color: #cba232;
}
...
.k-button-solid-error.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(203, 79, 50, 0.75);
}
...
.k-button-outline-base.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(76, 83, 86, 0.75);
}
...
.k-button-outline-primary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(16, 196, 178, 0.75);
}
...
.k-button-outline-secondary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(54, 57, 64, 0.75);
}
...
.k-button-outline-info.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(0, 153, 204, 0.75);
}
...
.k-button-outline-success.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(45, 178, 69, 0.75);
}
...
.k-button-outline-warning.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(254, 202, 63, 0.75);
}
...
.k-button-outline-error.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(254, 99, 63, 0.75);
}
...
.k-timeline-track-item.k-focus .k-timeline-circle {
  box-shadow: 0 3px 4px 0 rgba(16, 196, 178, 0.4);
}
.k-breadcrumb:focus,
...
.k-fab-solid-primary:active {
  border-color: #0c9587;
  background-color: #0c9587;
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(16, 196, 178, 0.4);
}
...
.k-fab-solid-secondary:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(54, 57, 64, 0.4);
}
...
.k-fab-solid-info:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(0, 153, 204, 0.4);
}
...
.k-fab-solid-success:active {
  border-color: #238935;
  background-color: #238935;
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(45, 178, 69, 0.4);
}
...
.k-fab-solid-warning:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(254, 202, 63, 0.4);
}
...
.k-fab-solid-error:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(254, 99, 63, 0.4);
}
...
.k-bottom-nav-solid.k-bottom-nav-primary .k-bottom-nav-item:focus {
  background-color: rgba(171, 234, 228, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-secondary .k-bottom-nav-item:focus {
  background-color: rgba(185, 186, 188, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-info .k-bottom-nav-item:focus {
  background-color: rgba(166, 219, 237, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-success .k-bottom-nav-item:focus {
  background-color: rgba(182, 228, 190, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-warning .k-bottom-nav-item:focus {
  background-color: rgba(89, 71, 22, 0.2);
}
...
.k-bottom-nav-solid.k-bottom-nav-error .k-bottom-nav-item:focus {
  background-color: rgba(255, 200, 188, 0.2);
}
...
.k-bottom-nav-flat .k-bottom-nav-item.k-selected:focus {
  background-color: rgba(76, 83, 86, 0.05);
}
...
.k-pivotgrid-row.k-selected > .k-pivotgrid-cell {
  background-color: rgba(16, 196, 178, 0.25);
}
...
.k-chip-solid-base {
  border-color: rgba(54, 57, 64, 0.3);
  color: #363940;
  background-color: rgba(54, 57, 64, 0.08);
}
.k-chip-solid-base:hover,
.k-chip-solid-base.k-hover {
  background-color: rgba(54, 57, 64, 0.16);
}
.k-chip-solid-base:focus,
.k-chip-solid-base.k-focus {
  box-shadow: 0 0 0 2px rgba(54, 57, 64, 0.16);
  background-color: rgba(54, 57, 64, 0.08);
}
.k-chip-solid-base.k-selected {
  background-color: rgba(54, 57, 64, 0.24);
}
.k-chip-solid-success {
  border-color: rgba(45, 178, 69, 0.3);
  color: #2db245;
  background-color: rgba(45, 178, 69, 0.08);
}
.k-chip-solid-success:hover,
.k-chip-solid-success.k-hover {
  background-color: rgba(45, 178, 69, 0.16);
}
.k-chip-solid-success:focus,
.k-chip-solid-success.k-focus {
  box-shadow: 0 0 0 2px rgba(45, 178, 69, 0.16);
}
.k-chip-solid-success.k-selected {
  background-color: rgba(45, 178, 69, 0.24);
}
.k-chip-solid-warning {
  border-color: rgba(254, 202, 63, 0.3);
  color: #feca3f;
  background-color: rgba(254, 202, 63, 0.08);
}
.k-chip-solid-warning:hover,
.k-chip-solid-warning.k-hover {
  background-color: rgba(254, 202, 63, 0.16);
}
.k-chip-solid-warning:focus,
.k-chip-solid-warning.k-focus {
  box-shadow: 0 0 0 2px rgba(254, 202, 63, 0.16);
}
.k-chip-solid-warning.k-selected {
  background-color: rgba(254, 202, 63, 0.24);
}
.k-chip-solid-error {
  border-color: rgba(254, 99, 63, 0.3);
  color: #fe633f;
  background-color: rgba(254, 99, 63, 0.08);
}
.k-chip-solid-error:hover,
.k-chip-solid-error.k-hover {
  background-color: rgba(254, 99, 63, 0.16);
}
.k-chip-solid-error:focus,
.k-chip-solid-error.k-focus {
  box-shadow: 0 0 0 2px rgba(254, 99, 63, 0.16);
}
.k-chip-solid-error.k-selected {
  background-color: rgba(254, 99, 63, 0.24);
}
.k-chip-solid-info {
...
.k-chip-solid-info.k-hover {
  background-color: rgba(0, 153, 204, 0.16);
}
.k-chip-solid-info:focus,
.k-chip-solid-info.k-focus {
  box-shadow: 0 0 0 2px rgba(0, 153, 204, 0.16);
}
...
.k-chip-outline-base.k-focus {
  box-shadow: 0 0 0 2px rgba(54, 57, 64, 0.08);
}
...
.k-no-color .k-color-preview-mask::before {
  content: "";
  background-image: url('data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2220%22%20height%3D%2220%22%20version%3D%221.1%22%3E%3Cline%20x1%3D%220%22%20x2%3D%2220%22%20y1%3D%220%22%20y2%3D%2220%22%20stroke%3D%22%23fe633f%22%20stroke-width%3D%221%22/%3E%3C/svg%3E');
  background-color: white;
...
.k-grid-columnmenu-popup .k-widget,
