...
.k-progressbar-indeterminate {
  ...
  color: #ffffff;
  background-color: #232323;
  background-image: linear-gradient(45deg, #202020 25%, transparent 25%, transparent 50%, #202020 50%, #202020 75%, transparent 75%, transparent);
...
.k-calendar-infinite .k-calendar-view::after {
  ...
  width: 150%;
  left: -25%;
  box-shadow: 0 0 32px 16px #101010;
}
...
.k-time-list::before,
.k-time-list::after {
  box-shadow: 0 0 3em 1.5em #101010;
}
...
.k-fab-item:hover .k-fab-item-icon {
  border-color: rgba(128, 128, 128, 0.1168);
  background-color: #484848;
}
...
.k-fab-item:active .k-fab-item-icon {
  border-color: rgba(172, 172, 172, 0.1536);
...
.k-pivotgrid-empty-cell {
  border-color: rgba(255, 255, 255, 0.2272);
}
.k-pivotgrid-row-headers .k-pivotgrid-row .k-pivotgrid-cell:last-child {
  border-right-color: rgba(255, 255, 255, 0.2272);
}
.k-pivotgrid-column-headers .k-pivotgrid-column-total:nth-last-of-type(2) .k-pivotgrid-cell:not(.k-pivotgrid-expanded),
.k-pivotgrid-column-headers .k-pivotgrid-row:last-child {
  border-bottom-color: rgba(255, 255, 255, 0.2272);
}
...
.k-taskboard-column.k-focus {
  border-color: rgba(219, 219, 219, 0.264);
}
.k-taskboard-column-header {
  color: #ffffff;
}
...
.k-taskboard-card.k-state-focus {
  border-color: rgba(255, 255, 255, 0.2456);
  box-shadow: none;
}
...
.k-task-milestone.k-task-delayed {
  background-image: repeating-linear-gradient(90deg, #000000, #000000 2px, #d51923 2px, #d51923 4px);
}
...
.k-task-offset {
  background-image: repeating-linear-gradient(135deg, #000000, #000000 2px, #d51923 2px, #d51923 4px);
}
...
.k-task-offset:hover {
  background-image: repeating-linear-gradient(135deg, #000000, #000000 2px, #e6757b 2px, #e6757b 4px);
}
...
.k-timeline .k-timeline-card .k-card-body {
  scrollbar-color: rgba(255, 255, 255, 0.08) #101010;
}
