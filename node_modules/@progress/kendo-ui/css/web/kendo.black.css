...
.k-button-solid-base.k-focus {
  border-color: #0066cc;
  box-shadow: 0 0 4px 0px rgba(0, 102, 204, 0.75);
}
...
.k-button-solid-tertiary.k-focus {
  box-shadow: 0px 0px 4px 0px rgba(0, 114, 169, 0.75);
}
...
.k-button-outline-tertiary.k-focus {
  border-color: currentColor;
  box-shadow: 0px 0px 4px 0px rgba(0, 143, 211, 0.75);
}
...
.k-calendar td.k-focus .k-link {
  box-shadow: inset 0 0 4px 0px rgba(0, 102, 204, 0.75);
}
...
.k-switch-off .k-switch-thumb {
  ...
  background-color: #272727;
  background-image: url('textures/glass.png');
  background-image: url('textures/glass.png'), linear-gradient(to bottom, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0));
}
.k-switch-off:focus,
...
.k-fab-solid-secondary:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(39, 39, 39, 0.4);
}
...
.k-fab-solid-tertiary:active {
  ...
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(0, 143, 211, 0.4);
}
...
.k-fab-item:active .k-fab-item-icon {
  border-color: #030303;
  background-color: #363636;
  box-shadow: 0 4px 5px rgba(0, 0, 0, 0.14), 0 1px 10px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(80, 80, 80, 0.4);
}
...
.k-bottom-nav-solid.k-bottom-nav-tertiary .k-bottom-nav-item:focus {
  background-color: rgba(166, 216, 240, 0.2);
}
