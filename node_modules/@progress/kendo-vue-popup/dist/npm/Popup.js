...
exports.PopupVue2 = exports.Popup = void 0; // @ts-ignore
...
var PopupVue2 = {
  ...
  created: function created() {
    ...
    this._domService = new domService_1.DOMService();
    this._alignService = new alignService_1.AlignService(this._domService);
    this._positionService = new positionService_1.PositionService(this._domService);
    this.reposition = (0, util_1.throttle)(this.reposition.bind(this), util_1.FRAME_DURATION);
  },
  // @ts-ignore
  ...
  mounted: function mounted() {
    if (kendo_vue_common_1.canUseDOM) {
      ...
      this.mountedAnchor = this.anchor ? this.getParentRef(this.anchor) : document.body;
    }
  ...
  methods: {
    ...
    calculatePosition: function calculatePosition($props, appendToElement) {
      if (!appendToElement || !(0, util_1.isWindowAvailable)() || !kendo_vue_common_1.canUseDOM) {
        return {
          flipped: false,
          offset: $props.offset
        };
