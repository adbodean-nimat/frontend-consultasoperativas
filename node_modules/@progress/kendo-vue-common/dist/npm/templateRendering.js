...
exports.transformListeners = exports.getTemplate = exports.templateRendering = exports.templateDefinition = void 0;
// @ts-ignore
var Vue = require("vue");
...
function templateRendering(template, listeners) {
    ...
    if (typeof template === 'string' || (0, isObject_1.isObject)(template) ||
...
exports.transformListeners = transformListeners;
